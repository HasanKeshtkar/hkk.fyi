...
(function (global) {
  ...
  var DICT = {
    ...
    fa: {
      ...
      "start.p1": "<a href=\"../hiding-a-voice-am/\">قسمت اول</a> بد تمام شد. مدولاسیون دامنه پیام را می‌گذارد در اینکه موج چقدر بلند است، و رعدوبرق و موتور و خورشید هم در همان می‌نویسند که موج چقدر بلند است. هیچ گیرنده‌ای این دو را از هم تشخیص نمی‌دهد، چون اصلاً چیزی نیست که با آن تشخیص بدهد.<br><br>راه فرار پیچ دوم است. کاری به ارتفاع نداشته باش و به‌جایش <em>زمان‌بندیِ</em> موج را هل بده. آن‌وقت گیرنده می‌تواند ارتفاع را، عمداً، پیش از آنکه به چیزی نگاه کند دور بریزد — و طوفان را هم با خودش دور می‌ریزد.<br><br>سال ۱۹۲۲ ریاضی‌دان بسیار خوبی ثابت کرد که این کار به جایی نمی‌رسد. حق با او بود، و حرفه یازده سال حرفش را باور کرد. <b>آنچه آرمسترانگ پیدا کرد اشتباهی در اثبات نبود.</b> بهایی بود که به فکر کسی نرسیده بود ارزش پرداختن دارد.",
      ...
      "start.li1": "پیام را ببر در <em>زمان‌بندیِ</em> موج؛ آن‌وقت ارتفاع موج اضافی می‌شود. گیرنده می‌تواند پیش از هر کار دیگری صافش کند، و هر چه در ارتفاع نوشته شده — که همه‌اش نویز است — با همان می‌رود.",
      "start.li2": "کارسون سال ۱۹۲۲ ثابت کرد که مدولاسیون فرکانس پهنای‌باند صرفه‌جویی نمی‌کند. <b>حق با او بود.</b> یک سیگنال FM باریک نه باریک‌تر از AM است و نه ساکت‌تر.",
      "start.li3": "جواب آرمسترانگ در ۱۹۳۳ این بود که دست از تلاش بردارد. فرکانس را <em>مسخره‌وار</em> پهن بچرخان — دوازده برابر آنچه پیام لازم دارد — آن‌وقت نوسان فازِ خود سیگنال از نوسان نویز بالاتر قد می‌کشد. <b>سکوت، خریداری‌شده با پهنای‌باند.</b>",
      "start.li4": "نرخ این معامله تند است و واقعی: نوسان را دو برابر کن، حدود شش دسی‌بل ببر. همان معاملهٔ پهنای‌باند در برابر سیگنال‌به‌نویزِ شنون است، پانزده سال زودتر، پیداشده به دست کسی که اثباتِ بی‌فایده بودنش را نشانش داده بودند.",
      "start.li5": "و یک کف هم دارد. زیر حدود ده دسی‌بلِ حامل روی نویز، گیرنده گم می‌کند که فِیزور از کدام طرف چرخیده و صدا پر می‌شود از تق‌تق. <b>FM از AM بهتر است، تا همان لحظه‌ای که ناگهان خیلی بدتر می‌شود.</b>",
      ...
      "s1.p1": "فکر اینکه به‌جای دامنهٔ فرستنده فرکانسش را تکان بدهی نه باهوشانه است و نه کسی لازم بوده اختراعش کند؛ به ذهن همه می‌رسد، و سال ۱۹۰۲ هم رسیده بود. دلیل اینکه مدام به ذهن‌ها می‌رسید شهودی بود که انگار جواب نداشت: یک ایستگاه AM دو طرف حاملش نوار کناری لازم دارد و نوارهای کناری جا می‌گیرند، اما اگر به‌جای اضافه کردن چیزی در کنارش فقط خود حامل را کمی <em>جابه‌جا</em> کنی، مسلماً تقریباً هیچ جایی لازم نداری — نه؟ ایستگاهی که چند صد هرتز اشغال کند، و ده برابر ایستگاه در همان باند.",
      "s1.p2": "جان رنشاو کارسون، در AT&amp;T، این ایده را آن‌قدر جدی گرفت که حسابش را بکند، و نتیجه را فوریهٔ ۱۹۲۲ در <em>Proceedings of the IRE</em> چاپ کرد. مقالهٔ کوتاهی است و کاملاً درست. تکان دادن فرکانس یک خط واحد که جابه‌جا شود تولید نمی‌کند؛ یک حامل تولید می‌کند به‌اضافهٔ خانواده‌ای بی‌پایان از نوارهای کناری، دقیقاً مثل مدولاسیون دامنه. و اگر تکان را کوچک نگه داری، نتیجه <em>هیچ باریک‌تر</em> از AM نیست. حکمش دربارهٔ FM باریک‌باند این بود که «ذاتاً اعوجاج ایجاد می‌کند، بدون هیچ مزیت جبران‌کننده‌ای».",
      ...
      "s2.p1": "ادوین آرمسترانگ همان موقع هم سه تا از چیزهای داخل رادیوی تو را اختراع کرده بود: بازتولید در ۱۹۱۲، وقتی بیست‌ودو ساله بود؛ سوپرهترودین در ۱۹۱۸، که بیش از یک قرن بعد هنوز هم روش کار عملاً هر گیرنده‌ای روی زمین است؛ و فوق‌بازتولید در ۱۹۲۲. پولدار بود، مشهور بود، و یک دهه سر اولی با لی دو فارست دعوای ثبت‌اختراع داشت — دعوایی که آخرش سر یک نکتهٔ فنی باخت، و بیشتر مهندس‌ها تا امروز حکمش را ناعادلانه می‌دانند.",
      "s2.p2": "بیشترِ اوایل دههٔ ۱۹۳۰ را در آزمایشگاهی زیرزمینی در کلمبیا گذراند و کاری می‌کرد که از بیرون شبیه مردی بود که حاضر نیست اثباتی را قبول کند. دسامبر ۱۹۳۳ چهار ثبت‌اختراع برایش صادر شد، و نوامبر ۱۹۳۵ در جلسهٔ انجمن مهندسان رادیو در نیویورک بلند شد، گیرنده‌ای را روشن کرد، و سیگنالی را برای اتاق پخش کرد که زنده از یک ایستگاه آماتوری در یانکرز می‌آمد. یک لیوان آب ریخت. یک ورق کاغذ مچاله کرد. یک صفحهٔ پیانو گذاشت. همهٔ آدم‌های آن اتاق می‌دانستند این صداها از روی هوا قرار است چه شکلی باشند — یک هیس که چیزی پشتش اتفاق می‌افتد — و به‌جایش صدای آب، صدای آب بود.",
      "s2.p3": "عددی که اهمیت داشت این بود که چقدر داشت فرکانس را می‌چرخاند. نه چند صد هرتز؛ هفتادوپنج هزار. برای فرستادن یک سیگنال صوتیِ پانزده کیلوهرتزی، آرمسترانگ دویست کیلوهرتز از طیف را اشغال می‌کرد — بیشتر از سهم بیست ایستگاه AM — و عمداً این کار را می‌کرد.",
      "s2.p4": "نسبت این دو تنها عدد این مقاله است که باید نگهش داری:",
      "s2.eqlbl1": "شاخص مدولاسیون",
      "s2.p5": "پخش FM با <span class=\"q\">Δf = 75 kHz</span> در برابر <span class=\"q\">W = 15 kHz</span> کار می‌کند، یعنی <b>β = 5</b>. FM باریک‌باندِ کارسون، همان که قضیه‌اش درباره‌اش بود، β‌اش خیلی زیر ۱ است. همان معادلات، همان فیزیک، همان مقاله — بیست برابر فاصله روی یک دیال، که یک سرش اتلاف وقت است و سر دیگرش کیفیت بالا.",
      "s2.h21": "<span class=\"secnum\">03</span> نوارهای کناریِ بی‌پایان",
      "s3.p1": "آنچه کارسون پیدا کرد این است، و راستش عجیب است. مدولاسیون دامنه یک تُن تک را در حامل می‌گذارد و دقیقاً سه خط تحویل می‌دهد: حامل، و یک نوار کناری در هر طرف. اما مدولاسیون فرکانس همان یک تُن را می‌گیرد و حامل را تحویل می‌دهد به‌اضافهٔ <em>بی‌نهایت</em> جفت نوار کناری، به فاصلهٔ فرکانس همان تُن، که تا ابد به هر دو طرف رژه می‌روند.",
      "s3.p2": "البته ته می‌کشند، و تنها دلیل قابل استفاده بودن این ماجرا هم همین است. اینکه چقدر تند ته بکشند را β تعیین می‌کند، و ارتفاعشان از خانواده‌ای از توابع درمی‌آید که فریدریش بسل دههٔ ۱۸۲۰ سر حساب مدار سیاره‌ها درشان آورد و کوچک‌ترین دلیلی نداشت به رادیو ربطشان بدهد.",
      "s3.eqlbl1": "ارتفاع nاُمین جفت نوار کناری",
      "s3.p3": "و توابع بسل کاری می‌کنند که هیچ شهودی دربارهٔ رادیو آدم را برایش آماده نکرده: <b>از صفر رد می‌شوند.</b> J<sub>0</sub>(β)، که ارتفاع خود حامل است — همان چیزی که کل فرستنده دورش ساخته شده و AM دوسوم توانش را خرجش می‌کند — وقتی β برابر ۲٫۴۰۵ باشد صفر است. نوسان را دقیقاً روی همین نسبت ببر: حامل ضعیف نمی‌شود، <em>نیست</em>. کل توان رفته در نوارهای کناری.",
      "s3.span1": "شکل ۱",
      "s3.span2": "β را بکش تا حامل غیب شود",
      "s3.span3": "شاخص مدولاسیون",
      "s3.note1": "صدا دارد. اول صدا را کم کن.",
      "s3.cap1": "یک حامل <span class=\"q\">1.2 kHz</span> که یک تُن <span class=\"q\">100 Hz</span> تکانش می‌دهد. خط تیرهٔ وسط حامل است و آبی‌ها نوارهای کناری‌اند؛ آن ساقهٔ کم‌رنگ خط‌چین هم جایی است که یک حامل تمام‌قوت می‌رسید. β را از صفر ببر بالا و ببین جفت‌ها یکی‌یکی سبز می‌شوند و نوار سایه‌دار — همان قاعدهٔ سرانگشتی خود کارسون برای اینکه این چیز چقدر جا می‌خواهد — با آن‌ها بزرگ می‌شود. بعد <b>«صفر ۱»</b> را بزن. حامل کم‌رنگ نمی‌شود؛ <b>می‌رود.</b> مهندس‌ها دهه‌ها از این به‌عنوان نوسان‌سنج استفاده می‌کردند: مدولاسیون را بپیچان تا وسط صفحه غیب شود، آن‌وقت می‌دانی نوسان دقیقاً ۲٫۴۰۵ برابر تُن است. دکمهٔ شنیدن را بزن و β را بکش؛ پایین نمایشگر هم ارزش نگاه کردن دارد، چون مجموع توان همهٔ نوارهای کناری همیشه ۱ می‌ماند. چیزی ساخته نمی‌شود، فقط پخش می‌شود.",
      "s3.p4": "خریدن طیف برای بی‌نهایت نوار کناری کار ناجوری است، پس کارسون — که تا آن موقع پانزده سال بود حق با او بود — تقریبی هم به صنعت داد که هنوز از آن استفاده می‌کند. نوارهای کناری‌ای را که مهم‌اند بشمار و بقیه را ول کن:",
      ...
      "s4.p1": "حالا آن بخشی که مقالهٔ کارسون پوششش نداد، چون آن مقاله‌ای دربارهٔ پهنای‌باند بود و این حرفی است دربارهٔ هندسه.",
      "s4.p2": "سیگنال دریافتی را مثل یک فلش بکش — یک فِیزور — با یک طول و یک زاویه. FM طول را ثابت نگه می‌دارد و زاویه را تکان می‌دهد: نوکش روی یک دایره می‌دود و هیچ‌وقت از آن بیرون نمی‌رود. نویز فلش دومی است، خیلی کوتاه‌تر، که به نوک اولی چسبیده و تصادفی دور خودش می‌چرخد. گیرنده هیچ‌وقت چیزی جز جمع این دو را نمی‌بیند، و سؤال این است که فلش کوچک چقدر از <em>زاویه</em> را می‌تواند بدزدد.",
      "s4.sum2": "یک لحظه — فِیزور یعنی چه؟",
      "s4.p8": "یک حقهٔ دفترداری، و مفیدترین حقهٔ کل رادیو. یک موج سینوسی یکنواخت فقط دو خاصیت دارد که ارزش ردگیری داشته باشد: چقدر بلند است، و الان کجای چرخه‌اش است. پس بکشش به شکل <b>یک فلش</b> — طول یعنی ارتفاع موج، زاویه یعنی کجای چرخه است. کل فلش با فرکانس حامل دور می‌زند، و تو قرار می‌گذاری دیگر به چرخش نگاه نکنی و فقط آنچه از آن می‌ماند را ببینی.",
      "s4.p9": "سودش این است که جمع کردن دو موج می‌شود جمع کردن دو فلش، نوک به ته، که چیزی است که می‌شود دیدش. حرف شکل پایین هم همین است: یک فلش بزرگ برای سیگنال، یک کوچک برای نویز که به نوکش چسبیده، و این سؤال که کوچک چقدر می‌تواند جمع را بپیچاند.",
      ...
      "s5.p4": "منصفانه مقایسه کردن دو روش سخت‌تر از چیزی است که به نظر می‌آید، چون جای یکسانی اشغال نمی‌کنند. سیگنال را در برابر نویز <em>در پهنای‌باند خود هر کدام</em> اعلام کن: پهن، پیش از آنکه کاری کرده باشد بدتر به نظر می‌آید، صرفاً به جرم پهن بودن. در برابر نویزِ یک برش ثابت اعلامش کن: بی‌سروصدا جواب را از پیش فرض کرده‌ای.",
      "s5.p5": "پس لغزنده با تنها واحدی تنظیم شده که طرف کسی را نمی‌گیرد: <b>توان دریافتی در برابر نویزِ داخل یک پهنای‌باند پیام</b> — یعنی چقدر سیگنال می‌رسد، به ازای هر واحد از آنچه فرستاده می‌شود. هر دو روش همان توان فرستنده و همان آسمان را می‌گیرند، و اینکه هر کدام با پهنای‌باندش چه می‌کند دیگر جواب پس دادنش با خودش است.",
      "s5.p2": "شکل پایین شبیه‌سازی واقعی هر دوست: نویز به سیگنال اضافه می‌شود، بعد یک طرف از یک آشکارساز پوش واقعی رد می‌شود و طرف دیگر از یک آشکارساز فرکانس واقعی، و خروجی در برابر همان گیرنده که در سکوت کار می‌کند سنجیده می‌شود. هیچ چیزی در آن منحنیِ کشیده‌شده از روی کتاب درسی نیست.",
      "s5.span1": "شکل ۳",
      ...
      "s6.p5": "همان تندی شیب اثر دیگری هم می‌سازد، و نام این یکی را مردم در حرف روزمره هم به کار می‌برند. اگر دو ایستگاه FM روی یک فرکانس بیفتند و یکی حتی اندکی قوی‌تر باشد، آشکارساز فِیزور قوی‌تر را دنبال می‌کند و ضعیف‌تر صرفاً وجود ندارد. نه قاطی‌پاتی — <em>سکوت</em> از طرف بازنده. به آن می‌گویند <b>اثر تسخیر</b>، و به همین دلیل است که می‌توانی بین دو شهر روی یک فرکانس FM رانندگی کنی و به‌جای یک آشغال، تحویلی تمیز بشنوی.",
      "s6.box1": "<b>و دقیقاً به همین دلیل هواپیماها هنوز AM به کار می‌برند.</b> کنترل ترافیک هوایی، روی <span class=\"q\">118–137 MHz</span>، سال ۲۰۲۶ هم مدولاسیون دامنه است، و این از سر غفلت نیست. در AM، دو خلبان که هم‌زمان بفرستند جیغ هترودینِ گوش‌خراشی تولید می‌کنند و همه فوراً می‌فهمند اتفاقی افتاده. در FM، قوی‌تر کانال را تسخیر می‌کرد و ضعیف‌تر بی‌هیچ ردی محو می‌شد — از جمله، مثلاً، هواپیمایی که دارد وضعیت اضطراری اعلام می‌کند درست وقتی یکی دیگر دارد مجوزی را تکرار می‌کند. <em>عیبِ</em> قسمت اول اینجا ویژگی ایمنی است. کسی قرار نیست عوضش کند.",
      "s6.h21": "<span class=\"secnum\">07</span> مردی که پرید",
      "s7.p1": "آرمسترانگ FM را از آنتنی روی ساختمان امپایر استیت آزمایش می‌کرد، روی جایی که دوست قدیمی‌اش دیوید سارنوف — که رئیس RCA بود — برایش جور کرده بود. سال ۱۹۳۵ RCA از او خواست دستگاه‌هایش را جمع کند؛ دکل را برای تلویزیون لازم داشتند.",
      "s7.p2": "همان‌جاست که قصه می‌چرخد، و می‌ارزد دقیق بگوییم چرا. کسب‌وکار RCA همان AM بود: فرستنده، گیرنده، ثبت‌اختراع، شبکه‌های وابسته، کل بساط پخش رادیویی آمریکا. یک روش مدولاسیون بهتر برای آن‌ها فرصت نبود؛ حکم منسوخ شدن بود که تازه باید پولش را هم به آرمسترانگ می‌دادند.",
      "s7.p3": "پس ایستگاه خودش را ساخت. با پول خودش در آلپاین نیوجرسی دکلی زد، و تا ۱۹۴۰ ایستگاه FM بود و گیرندهٔ FM بود و مخاطبی کوچک و پرشور که شنیده بود رادیو قرار بوده چه صدایی بدهد. و ژوئن ۱۹۴۵ کمیسیون FCC — بعد از جلساتی که RCA در آن‌ها سرسختانه، با استدلال‌های فنی‌ای که بعداً بی‌اعتبار شدند، گفت باند موجود مناسب نیست — FM را از <span class=\"q\">42–50 MHz</span> برد بالا روی <span class=\"q\">88–108 MHz</span>.",
      ...
      "s8.cap1": "آنچه واقعاً حامل را مدوله می‌کند صدا نیست؛ کل این پشته است، که به آن سیگنال مرکب یا مالتی‌پلکس می‌گویند. خط خط‌چین روی <span class=\"q\">15 kHz</span> جایی است که یک گیرندهٔ قدیمی از شنیدن دست می‌کشید، و هر چه سمت راستش هست طوری انتخاب شده که آن سوی همان خط زندگی کند. آن سوزن کوچک روی <span class=\"q\">19 kHz</span> همان <b>پایلوت</b> است: بالاتر از آن است که شنیده شود، و تنها کارش این است که به یک دستگاه استریو بگوید استریو هست و ۳۸ کیلوهرتز کجاست. دو کانال را متفاوت بگذار، نوار تفاضل بزرگ می‌شود؛ برابرشان کن، کاملاً محو می‌شود — و به همین دلیل یک برنامهٔ مونو روی یک ایستگاه استریو هیچ خرج اضافه‌ای ندارد. <b>تیک جعبه را بزن</b> تا همان‌طور بشنوی‌اش که ۱۹۵۹ می‌شنید. برنامه هنوز سر جایش است؛ فقط دیگر در دو جا نیست.",
      "s8.p3": "همین حقه دههٔ ۱۹۸۰ دوباره زده شد: RDS، همان چیزی که نام ایستگاه را روی نمایشگر ماشینت می‌آورد، سوار زیرحامل دیگری روی <span class=\"q\">57 kHz</span> است — سه برابر پایلوت — و برای هر چه پیش از آن آمده به همان اندازه نامرئی است.",
      "s8.p4": "و بعد عجیب‌ترین زندگیِ پس از مرگِ کل ماجرا. سال ۱۹۶۷ آهنگ‌سازی در استنفورد به نام جان چاونینگ داشت با ویبراتو روی کامپیوتر ور می‌رفت، نرخ مدولاسیون را برد بالاتر از جایی که یک لرزش تبدیل به یک تُن می‌شود، و نوارهای کناری را شنید. ریاضیات آرمسترانگ را دوباره کشف کرده بود، این بار به‌عنوان راهی برای ساختن صداهایی که کسی نشنیده بود. استنفورد لیسانسش را به یاماها داد؛ DX7 سال ۱۹۸۳ عرضه شد و پرفروش‌ترین سینتی‌سایزر تاریخ شد. هر پیانوی الکتریک شیشه‌ایِ هر آلبوم آن دهه J<sub>n</sub>(β) است.",
      ...
      "s8.p6": "<b>AM</b> نقطه را روی یک خط جلو و عقب می‌برد و کل اطلاعات در فاصله از مبدأ است. <b>PM</b> و <b>FM</b> فاصله را ثابت نگه می‌دارند و روی کمان می‌چرخانندش. <b>SSB</b> با نرخ ثابت دور یک دایره می‌بردش، و به همین دلیل پوشی ندارد که آشکار شود. و <b>QAM</b> — هر مودم، هر لینک وای‌فای، هر سیگنال تلویزیون دیجیتال — دست از تظاهر به فرق داشتن این دو برمی‌دارد و نقطه را هر جا دلش خواست می‌پراند.",
      "s8.cap2": "یک نقطه، یک صفحه، و موجی که سمت راست از آن درمی‌آید. پیچ‌های بخش دوم قسمت اول هنوز دقیقاً همان دو پیچ‌اند — چقدر دور، و از کدام طرف — و تنها چیزی که صد سال عوض کرده این است که یک رادیو حالا نقطه را مستقیم حرکت می‌دهد، با یک جفت مبدل دیجیتال به آنالوگ، به‌جای اینکه برای هر ایده یک مدار بسازد. سهم آرمسترانگ در این تصویر همین مشاهده است که کمان جای بسیار امن‌تری برای نوشتن است تا شعاع.",
      "s8.box1": "طبیعت با دامنه می‌نویسد. پس تو ننویس.",
      "s8.span7": "قبلی",
      "s8.span8": "<a href=\"../hiding-a-voice-am/\">قسمت اول — AM و دردسر دامنه</a>. اینکه چرا یک صدا اصلاً حامل لازم دارد، یک دیود و یک خازن به‌تنهایی چه می‌کنند، و آن دوسوم دیگر فرستنده کجا می‌رود.",
      "s8.h32": "منابع و خواندن بیشتر",
      "s8.li1": "J. R. Carson, “Notes on the Theory of Modulation,” <em>Proceedings of the IRE</em>, vol. 10, no. 1, Feb. 1922 — خود اثبات، و سرچشمهٔ قاعدهٔ پهنای‌باندی که نام او را دارد.",
      ...
      "s8.li5": "J. M. Chowning, “The Synthesis of Complex Audio Spectra by Means of Frequency Modulation,” <em>Journal of the Audio Engineering Society</em>, vol. 21, no. 7, 1973.",
      "s8.li6": "A. B. Carlson, <em>Communication Systems</em>, 5th ed., McGraw-Hill — فصل‌های ۵ و ۱۰، برای طیف بسل، آستانه، و مدل تق‌هایی که پشت شکل ۴ نشسته.",
      ...
      "meta.description": "سال ۱۹۲۲ یک اثبات گفت مدولاسیون فرکانس بی‌فایده است، و اثبات درست بود. سال ۱۹۳۳ آرمسترانگ با تنها کاری که به فکر کسی نرسیده بود به کارش انداخت: خرج کردن پهنای‌باند، به‌جای صرفه‌جویی در آن. شش شکل تعاملی، سه تاش صدادار. قسمت دوم از دو.",
      "meta.og:title": "پنهان کردن یک صدا در یک موج — FM و بهای سکوت",
      "meta.og:description": "توابع بسل، حاملی که غیب می‌شود، چرا پهن یعنی ساکت، پرتگاهی که ته معامله است، و مردی که به خاطرش از پنجره پرید.",
      "meta.og:image:alt": "یک فِیزور روی یک دایره که ردش جمع و باز می‌شود، کنار عنوان مقاله.",
      "js.src.voice": "مصنوعی",
      "js.src.music": "موسیقی",
      "js.yes": "بله",
      "js.no": "نه",
      ...
      "js.ph.click": "نویز حالا می‌تواند از آن سوی مبدأ رد شود — این یعنی تق",
      ...
      "js.mpx.xaxis": "فرکانس در سیگنال مرکب، کیلوهرتز",
      ...
      "js.mpx.l_comp": "سیگنال مرکب، در زمان",
      "js.mpx.l_mono": "آنچه دستگاه مونو پخش می‌کند · کم‌رنگ = کل مرکب",
      "js.mpx.ro_l": "چپ",
      "js.mpx.ro_r": "راست",
      "js.mpx.ro_sum": "L + R",
      "js.mpx.ro_dif": "L − R",
