...
(function (global) {
  ...
  var DICT = {
    ...
    fa: {
      "hero.title1": "قایم‌کردن یک صدا داخل یک موج — FM و بهای سکوت · hkk.fyi",
      "hero.a1": "برو سراغ متن",
      "hero.a2": "آزمایشگاه",
      "hero.a3": "نوشته‌ها",
      "hero.a4": "رزومه",
      "hero.a5": "تماس",
      "start.span1": "مقاله · رادیو · قسمت دوم از دو · حدود ۱۷ دقیقه · ۶ شکل زنده، ۳ تاش صدا دارد",
      "start.h11": "FM و بهای سکوت",
      "start.p1": "<a href=\"../hiding-a-voice-am/\">قسمت اول</a> بد تموم شد. مدولاسیون دامنه پیام رو می‌ذاره توی اینکه موج چقدر بلنده، و رعدوبرق و موتور و خورشید هم توی همون می‌نویسن که موج چقدر بلنده، و هیچ گیرنده‌ای نمی‌تونه این دوتا رو از هم تشخیص بده — چون اصلاً چیزی نیست که باهاش تشخیص بده.<br><br>راهِ فرار پیچِ دومه. کاری به ارتفاع نداشته باش، و به‌جاش <em>زمان‌بندیِ</em> موج رو هل بده. اون‌وقت گیرنده می‌تونه ارتفاع رو، عمداً، قبل از اینکه به هیچی نگاه کنه بریزه دور — و طوفان رو هم با خودش می‌ریزه دور.<br><br>سال ۱۹۲۲ یه ریاضی‌دانِ خیلی خوب ثابت کرد که این نمی‌تونه کمکی بکنه. حق با اون بود، و حرفه یازده سال باورش کرد. <b>چیزی که آرمسترانگ پیدا کرد اشتباهی در اثبات نبود.</b> بهایی بود که هیچ‌کس فکر نمی‌کرد ارزشِ پرداختن داشته باشه.",
      ...
      "start.li1": "پیام رو ببر توی <em>زمان‌بندیِ</em> موج، و اون‌وقت ارتفاعِ موج اضافی می‌شه. گیرنده می‌تونه قبل از هر کارِ دیگه‌ای صافش کنه، و هرچی توی ارتفاع نوشته شده — که همهٔ نویزه — با همون می‌ره.",
      "start.li2": "کارسون سال ۱۹۲۲ ثابت کرد مدولاسیون فرکانس پهنای‌باند صرفه‌جویی نمی‌کنه. <b>حق با او بود.</b> یه سیگنالِ FMِ باریک نه باریک‌تر از AM ئه نه ساکت‌تر.",
      "start.li3": "جوابِ آرمسترانگ در ۱۹۳۳ این بود که دست از تلاش برداره. فرکانس رو <em>مسخره‌وار</em> پهن بچرخون — دوازده برابرِ چیزی که پیام لازم داره — و نوسانِ فازِ خودِ سیگنال بالای سرِ نوسانِ نویز قد می‌کشه. <b>سکوت، خریداری‌شده با پهنای‌باند.</b>",
      "start.li4": "نرخِ این معامله تند است و واقعی: نوسان رو دوبرابر کن، حدود شش دسی‌بل ببر. همون معاملهٔ پهنای‌باند در برابر سیگنال‌به‌نویزِ شنونه، پونزده سال زودتر، پیداشده توسط کسی که اثباتِ بی‌فایده‌بودنش رو بهش نشون داده بودن.",
      "start.li5": "و یه کف هم دارد. زیرِ حدود ده دسی‌بلِ حامل روی نویز، گیرنده گم می‌کنه که فِیزور از کدوم طرف چرخیده، و صدا پر می‌شه از تق‌تق. <b>FM از AM بهتر است، تا همان لحظه‌ای که یک‌دفعه خیلی بدتر می‌شود.</b>",
      "start.p2": "شش چیز برای کشیدن، سه تا برای شنیدن، و بیستِ سالِ خیلی بدِ یک مرد.",
      "start.span8": "فهرست",
      "start.li6": "<a href=\"#s1\">قضیه‌ای که گفت بی‌فایده است</a>",
      "start.li7": "<a href=\"#s2\">پس از آن طرف برو</a>",
      ...
      "start.h21": "<span class=\"secnum\">01</span> قضیه‌ای که گفت بی‌فایده است",
      "s1.p1": "فکرِ تکون‌دادنِ فرکانسِ فرستنده به‌جای دامنه‌اش نه باهوشانه‌ست و نه کسی لازم بوده اختراعش کنه. به ذهنِ همه می‌رسه. سال ۱۹۰۲ هم به ذهنِ آدم‌ها رسیده بود. و دلیلِ اینکه مدام به ذهن‌ها می‌رسید یه شهودی بود که بی‌جواب به‌نظر می‌آمد: یه ایستگاهِ AM دو طرفِ حاملش نوارِ کناری لازم داره، و نوارهای کناری جا می‌گیرن — ولی اگه به‌جای اضافه‌کردنِ چیزی کنارش، فقط خودِ حامل رو یه ذره <em>جابه‌جا</em> کنی، مسلماً تقریباً هیچ جایی لازم نداری، نه؟ ایستگاهی که چند صد هرتز اشغال می‌کنه. ده برابر ایستگاه توی همون باند.",
      "s1.p2": "جان رنشاو کارسون، در AT&amp;T، این ایده رو اون‌قدر جدی گرفت که حسابش رو بکنه، و نتیجه رو فوریهٔ ۱۹۲۲ توی <em>Proceedings of the IRE</em> منتشر کرد. مقالهٔ کوتاهیه و کاملاً درسته. تکون‌دادنِ فرکانس یه خطِ واحد که جابه‌جا بشه تولید نمی‌کنه. یه حامل تولید می‌کنه به‌علاوهٔ یه خانوادهٔ بی‌پایان از نوارهای کناری، دقیقاً مثل مدولاسیون دامنه، و اگه تکون رو کوچیک نگه داری نتیجه <em>هیچ باریک‌تر</em> از AM نیست. حکمش دربارهٔ FMِ باریک‌باند این بود که «ذاتاً اعوجاج ایجاد می‌کند، بدون هیچ مزیتِ جبران‌کننده‌ای».",
      "s1.cite1": "— جمله‌ای که همه کارسون را با آن به یاد می‌آورند، و نظرِ جاافتادهٔ حرفه برای یک دههٔ بعد",
      "s1.box1": "«استاتیک، مثل فقرا، همیشه با ما خواهد بود.» <cite data-i18n=\"s1.cite1\">— جمله‌ای که همه کارسون را با آن به یاد می‌آورند، و نظرِ جاافتادهٔ حرفه برای یک دههٔ بعد</cite>",
      "s1.p3": "اگه این رو پوزخندِ آدمی بخونی که آخرش اشتباه از آب درآمد، چیزِ جالبش رو از دست می‌دی. کارسون کم‌تخیل نبود. یه قضیهٔ واقعی ثابت کرده بود، و اون قضیه هنوز هم درسته: <b>نمی‌توانی با مدوله‌کردنِ فرکانسِ یک سیگنال، آن را در جای کمتری بچپانی.</b> هر تلاشی برای باریک‌کردنِ FM به سیگنالی ختم می‌شه که به‌پهنای AM ئه و از هر جهتِ دیگه بدتر.",
      "s1.p4": "چیزی که قضیه <em>نمی‌گه</em> — چیزی که به ذهنِ هیچ‌کس نرسید بپرسه، چون آخه چرا باید می‌رسید — اینه که اگه از <em>اون‌طرف</em> بری چی می‌شه.",
      "s1.h21": "<span class=\"secnum\">02</span> پس از آن طرف برو",
      "s2.p1": "ادوین آرمسترانگ همین الانش هم سه تا از چیزهای داخلِ رادیوت رو اختراع کرده بود. بازتولید در ۱۹۱۲، وقتی بیست‌ودو ساله بود. سوپرهترودین در ۱۹۱۸، که بیش از یک قرن بعد هنوز هم روشِ کارِ عملاً هر گیرنده‌ای روی زمینه. فوق‌بازتولید در ۱۹۲۲. پولدار بود، مشهور بود، و یه دهه سرِ اولی با لی دو فارست دعوای حقوقیِ ثبت‌اختراع داشت، که آخرش سرِ یه نکتهٔ فنی باخت — نکته‌ای که بیشترِ مهندس‌ها تا امروز حکمش رو ناعادلانه می‌دونن.",
      "s2.p2": "بیشترِ اوایلِ دههٔ ۱۹۳۰ رو توی یه آزمایشگاهِ زیرزمینی در کلمبیا گذروند و کاری می‌کرد که از بیرون شبیهِ آدمی بود که حاضر نیست یه اثبات رو قبول کنه. دسامبر ۱۹۳۳ چهار ثبت‌اختراع براش صادر شد. نوامبر ۱۹۳۵ توی جلسهٔ انجمن مهندسان رادیو در نیویورک بلند شد، یه گیرنده رو روشن کرد، و سیگنالی رو برای اتاق پخش کرد که زنده از یه ایستگاهِ آماتوری در یانکرز می‌آمد. یه لیوان آب ریخت. یه ورق کاغذ مچاله کرد. یه صفحهٔ پیانو گذاشت. همهٔ آدم‌های اون اتاق می‌دونستن این صداها از روی هوا قرار بود چه شکلی باشن — یه هیس که یه چیزی پشتش اتفاق می‌افته — و به‌جاش صدای آب، صدای آب بود.",
      "s2.p3": "عددی که مهم بود این بود که چقدر داشت فرکانس رو می‌چرخوند. نه چند صد هرتز. هفتادوپنج هزار. برای فرستادنِ یه سیگنالِ صوتیِ پونزده کیلوهرتزی، آرمسترانگ داشت دویست کیلوهرتز از طیف رو اشغال می‌کرد — بیشتر از سهمِ بیست تا ایستگاهِ AM — و عمداً این کار رو می‌کرد.",
      "s2.p4": "نسبتِ این دوتا تنها عددِ این مقاله‌ست که باید نگهش داری:",
      "s2.eqlbl1": "شاخصِ مدولاسیون",
      "s2.p5": "پخشِ FM با <span class=\"q\">Δf = 75 kHz</span> در برابرِ <span class=\"q\">W = 15 kHz</span> کار می‌کنه، یعنی <b><span class=\"q\">β = 5</span></b>. FMِ باریک‌باندِ کارسون، همونی که قضیه‌اش درباره‌ش بود، β‌اش خیلی زیرِ <span class=\"q\">1</span> ئه. همون معادلات، همون فیزیک، همون مقاله — بیست برابر فاصله روی یه دیال، و یه طرفِ اون دیال اتلافِ وقته و طرفِ دیگه‌اش کیفیتِ بالا.",
      "s2.h21": "<span class=\"secnum\">03</span> نوارهای کناریِ بی‌پایان",
      "s3.p1": "چیزی که کارسون پیدا کرد این بود، و واقعاً عجیبه. مدولاسیون دامنه یه تُنِ تک رو می‌ذاره توی حامل و دقیقاً سه تا خط پس می‌ده: حامل و یه نوارِ کناری هر طرف. مدولاسیون فرکانس همون تُنِ تک رو می‌گیره و حامل رو پس می‌ده به‌علاوهٔ <em>بی‌نهایت</em> جفت نوارِ کناری، به فاصلهٔ فرکانسِ همون تُن، که تا ابد به هر دو طرف رژه می‌رن.",
      "s3.p2": "البته که ته‌کش می‌کشن، و تنها دلیلِ قابلِ‌استفاده‌بودنِ این همه ماجرا همینه. اینکه چقدر تند ته‌کش بکشن رو β تعیین می‌کنه، و ارتفاع‌هاشون از خانواده‌ای از توابع درمی‌آد که فریدریش بسل دههٔ ۱۸۲۰ سرِ حسابِ مدارِ سیاره‌ها درشون آورده بود و کوچک‌ترین دلیلی نداشت ربطشون بده به رادیو.",
      "s3.eqlbl1": "ارتفاعِ nاُمین جفتِ نوارِ کناری",
      "s3.p3": "و توابع بسل کاری می‌کنن که هیچ شهودی دربارهٔ رادیو آدم رو براش آماده نکرده. <b>از صفر رد می‌شن.</b> J<sub>0</sub>(β) — که ارتفاعِ خودِ حامله، همون چیزی که کلِ فرستنده دورش ساخته شده، همونی که AM دوسومِ توانش رو خرجش می‌کنه — وقتی β برابرِ ۲٫۴۰۵ باشه صفره. نوسان رو دقیقاً روی همین نسبت ببر و حامل ضعیف نیست. <em>نیست.</em> کلِ توان رفته توی نوارهای کناری.",
      "s3.span1": "شکل ۱",
      "s3.span2": "β را بکش تا حامل ناپدید شود",
      "s3.span3": "شاخصِ مدولاسیون",
      "s3.note1": "صدا دارد. اول صدا را کم کن.",
      "s3.cap1": "یه حاملِ <span class=\"q\">1.2 kHz</span> که یه تُنِ <span class=\"q\">100 Hz</span> تکونش می‌ده. خطِ تیرهٔ وسط حامله و آبی‌ها نوارهای کناری‌ان؛ ساقهٔ کم‌رنگِ خط‌چین جاییه که یه حاملِ تمام‌قوت می‌رسید. β رو از صفر ببر بالا و ببین جفت‌ها یکی‌یکی ظاهر می‌شن و نوارِ سایه‌دار — همون قاعدهٔ سرانگشتیِ خودِ کارسون برای اینکه این چیز چقدر جا لازم داره — باهاشون بزرگ می‌شه. بعد <b>صفر ۱</b> رو بزن. حامل کم‌رنگ نمی‌شه؛ <b>می‌ره.</b> مهندس‌ها دهه‌ها ازش به‌عنوانِ نوسان‌سنج استفاده می‌کردن: مدولاسیون رو بپیچون تا وسطِ صفحه ناپدید بشه، اون‌وقت می‌دونی نوسان دقیقاً ۲٫۴۰۵ برابرِ تُنه. دکمهٔ گوش‌دادن رو بزن و β رو بکش، و پایینِ نمایشگر هم ارزشِ نگاه‌کردن داره — مجموعِ توانِ همهٔ نوارهای کناری همیشه ۱ می‌مونه، همیشه. چیزی ساخته نمی‌شه. فقط پخش می‌شه.",
      "s3.p4": "خریدنِ طیف برای بی‌نهایت نوارِ کناری کارِ ناجوریه، پس کارسون — که تا اون‌موقع پونزده سال بود حقّ با اون بود — تقریبی رو هم به صنعت داد که هنوز هم ازش استفاده می‌کنه. نوارهای کناری‌ای که مهم‌ان رو بشمار، بقیه رو ول کن:",
      "s3.eqlbl2": "قاعدهٔ کارسون",
      "s3.p5": "اعدادِ پخشِ FM رو بذار توش، درمی‌آد <span class=\"q\">2 × (75 + 15) = 180 kHz</span>، و دلیلِ اینکه کانال‌های FM دویست کیلوهرتز از هم فاصله دارن همینه، و دلیلِ اینکه دیال می‌ره ۸۸٫۱ و ۸۸٫۳ و ۸۸٫۵ هم همینه. مردی که قضیه‌اش گفت این کار بی‌فایده‌ست، همون مردیه که اسمش روی فرمولیه که کلِ صنعت باهاش باند رو می‌چینه.",
      "s3.h21": "<span class=\"secnum\">04</span> چرا پهن یعنی ساکت",
      "s4.p1": "حالا اون بخشی که مقالهٔ کارسون پوششش نداد، چون اون مقاله‌ای دربارهٔ پهنای‌باند بود و این بحثی‌ست دربارهٔ هندسه.",
      "s4.p2": "سیگنالِ دریافتی رو مثلِ یه فلش بکش — یه فِیزور — با یه طول و یه زاویه. FM طول رو ثابت نگه می‌داره و زاویه رو تکون می‌ده: نوکش روی یه دایره می‌دوه و هیچ‌وقت ازش بیرون نمی‌ره. نویز فلشِ دومیه، خیلی کوتاه‌تر، که به نوکِ اولی چسبیده و تصادفی دورِ خودش می‌چرخه. گیرنده هیچ‌وقت چیزی جز جمعِ این دوتا نمی‌بینه، و سؤال اینه که فلشِ کوچیکه چقدر از <em>زاویه</em> رو می‌تونه بدزده.",
      "s4.sum2": "صبر کن — فِیزور یعنی چی؟",
      "s4.p8": "یه حقهٔ دفترداری، و مفیدترین حقه‌ای که توی رادیو هست. یه موجِ سینوسیِ یکنواخت فقط دوتا خاصیتِ ارزشِ‌ردگیری داره — چقدر بلنده و الان کجای چرخه‌شه — پس بکشش به شکلِ <b>یه فلش</b>: طول ارتفاعِ موجه، زاویه جاییه که توی چرخه بهش رسیده. کلِ فلش با فرکانسِ حامل دور می‌زنه، و تو قرار می‌ذاری که دیگه به چرخش نگاه نکنی و فقط چیزی رو ببینی که باقی می‌مونه.",
      "s4.p9": "سودش اینه که جمع‌کردنِ دو موج تبدیل می‌شه به جمع‌کردنِ دو فلش، نوک‌به‌ته، که چیزیه که می‌شه دیدش. کلِ محتوای شکلِ پایین همینه: یه فلشِ بزرگ برای سیگنال، یه کوچیک برای نویز که به نوکش چسبیده، و این سؤال که کوچیکه چقدر می‌تونه جمع رو بپیچونه.",
      "s4.p3": "خیلی کم، و نکتهٔ اصلی اینجاست: <b>اینکه چقدر می‌دزده، هیچ ربطی ندارد به اینکه زاویهٔ خودِ سیگنال چقدر نوسان می‌کند.</b> فلشِ نویز همون‌قدر بلنده که هست. جمع رو تقریباً به‌اندازهٔ طولِ خودش تقسیم بر طولِ سیگنال کج می‌کنه، و تمام.",
      "s4.p4": "پس سیگنال رو بیشتر بچرخون. سهمِ نویز دقیقاً همون‌جا می‌مونه که بود، و چیزی که داری باهاش مقایسه‌اش می‌کنی بزرگ‌تر می‌شه. نوسان رو دوبرابر کن، نویز رو نصف کردی — توی تنها معنایی که اهمیت داره.",
      "s4.span1": "شکل ۲",
      "s4.span2": "کلِ معامله، به شکلِ یک مثلث",
      "s4.span3": "سیگنال چقدر نوسان می‌کند",
      "s4.span4": "حامل روی نویز",
      "s4.cap1": "آبی سیگناله، که داره کمانی رو جارو می‌کنه که پیام دورش می‌چرخونتش. دایرهٔ خط‌چینِ روی نوکش همهٔ جاهاییه که نویز می‌تونه بذاردش؛ فلشِ خاکستری جاییه که نویز همین لحظه گذاشتتش، و خطِ خط‌چین تا مبدأ تنها چیزیه که گیرنده واقعاً گیرش می‌آد. حالا اسلایدرِ بالا رو بکش. <b>دایرهٔ کوچیکه اندازه‌اش عوض نمی‌شه.</b> فقط کمان عوض می‌شه. کلِ اختراع همینه: دو تا میلهٔ سمتِ راست همون دو تا کمیت‌ان، و پهن‌کردنِ نوسان دقیقاً یکی‌شون رو پهن می‌کنه. بعد اسلایدرِ پایینی رو بکش زیرِ حدودِ <span class=\"q\">6 dB</span> و ببین دایرهٔ نویز اون‌قدر بزرگ می‌شه که می‌تونه از اون‌طرفِ مبدأ رد بشه — و از همون‌جا گیرنده دیگه نمی‌فهمه فِیزور از کدوم طرف چرخیده، و معامله فرومی‌ریزه.",
      "s4.p5": "دقیق‌بودن سرِ این ماجرا یه ضریبِ دیگه هم خرج برمی‌داره. آشکارسازی که زاویه رو دوباره به صدا تبدیل می‌کنه با مشتق‌گرفتن کار می‌کنه، و مشتق فرکانس‌های بالا رو بزرگ می‌کنه. پس نویزی که از یه گیرندهٔ FM بیرون می‌آد صاف نیست — با فرکانس بالا می‌ره، به شکلِ یه گُوِه که مهندس‌ها بهش می‌گن <em>نویزِ مثلثی</em>. حسابش رو که بکنی، سود با مجذورِ β مقیاس می‌خوره: <b>هر دوبرابرکردنِ نوسان حدود شش دسی‌بل می‌خرد.</b>",
      "s4.sum1": "ارزان‌ترین چارهٔ کلِ پخشِ رادیویی",
      "s4.p6": "اگه نویز به‌طرفِ بالای باندِ صوتی بدتر می‌شه، و زیرِ موسیقی هم اون بالا آروم‌تره، اون‌وقت حرکتِ بدیهی اینه که قبل از فرستادن زیر رو بیاری بالا و سرِ خروج دوباره ببریش پایین. تقویتِ سرِ ورود می‌شه <b>پیش‌تأکید</b>؛ برشِ متناظرش سرِ خروج می‌شه <b>واتأکید</b>، و چون نویز فقط وسطِ این دوتا اضافه می‌شه، اون برش هیس رو هم با خودش می‌بره پایین و موسیقی رو همون‌جا که بود می‌ذاره.",
      "s4.p7": "چیزی حدودِ ۱۳ دسی‌بلِ دیگه می‌خره و خرجش سرِ هر طرف یه مقاومت و یه خازنه. ثابتِ زمانی توی قارهٔ آمریکا <span class=\"q\">75 µs</span> ئه و توی بیشترِ بقیهٔ دنیا <span class=\"q\">50 µs</span> — از همون جزئیاتی که تا وقتی نخوای توی هر دوجا رادیو بفروشی به‌نظر بی‌اهمیت می‌آد.",
      "s4.h21": "<span class=\"secnum\">05</span> سکوت، خریداری‌شده",
      "s5.p1": "هندسه بس. همون پیام، همون توانِ فرستنده، همون طوفان، دو تا گیرنده.",
      "s5.sum1": "اسلایدرِ «رسیده» دقیقاً چه چیزی را می‌سنجد",
      "s5.p4": "منصفانه مقایسه‌کردنِ دو روش سخت‌تر از چیزیه که به‌نظر می‌آد، چون جای یکسانی اشغال نمی‌کنن. سیگنال رو در برابرِ نویز <em>توی پهنای‌باندِ خودِ هرکدوم</em> اعلام کن، اون‌وقت پهنه قبل از اینکه هیچ کاری بکنه بدتر به‌نظر می‌آد، صرفاً به‌جرمِ پهن‌بودن. در برابرِ نویزِ توی یه برشِ ثابت اعلامش کن، اون‌وقت بی‌سروصدا جواب رو از قبل فرض کردی.",
      "s5.p5": "پس اسلایدر با تنها واحدی تنظیم شده که طرفِ کسی رو نمی‌گیره: <b>توانِ دریافتی در برابرِ نویزِ داخلِ یک پهنای‌باندِ پیام</b> — چقدر سیگنال می‌رسه، به‌ازای هر واحد از چیزی که داره فرستاده می‌شه. هر دو روش همون توانِ فرستنده و همون آسمون رو می‌گیرن. اینکه هرکدوم با پهنای‌باندش چه می‌کنه، دیگه پاسخش با خودشه.",
      "s5.p2": "شکلِ پایین شبیه‌سازیِ واقعیِ هر دوتاست — نویز به سیگنال اضافه می‌شه، بعد یه طرف از یه آشکارسازِ پوشِ واقعی رد می‌شه و طرفِ دیگه از یه آشکارسازِ فرکانسِ واقعی، و خروجی در برابرِ همون گیرنده که توی سکوت کار می‌کنه سنجیده می‌شه. هیچ‌چیزِ این شکل منحنیِ کشیده‌شده از روی کتابِ درسی نیست.",
      "s5.span1": "شکل ۳",
      "s5.span2": "همان طوفان، دو بار",
      "s5.span3": "سیگنال روی نویز، رسیده",
      "s5.amlbl": "· AM",
      "s5.fmlbl": "· FM",
      "s5.note1": "صدا دارد. اول صدا را کم کن، بعد یکی و بعد اون‌یکی را بزن.",
      "s5.cap1": "خطِ بالا، مدولاسیون دامنه. خطِ پایین، مدولاسیون فرکانس با همون βای که خودت انتخاب می‌کنی — هر دو با همون توان می‌فرستن، هر دو با همون نویز خورده‌ان، و هرکدوم در برابرِ نسخهٔ خط‌چینِ خودشون در شرایطِ عالی کشیده شده‌ان. اسلایدر رو بذار حدودِ <b><span class=\"q\">26 dB</span></b> و دو تا دکمهٔ گوش‌دادن رو پشتِ‌هم بزن؛ همون مقایسه‌ایه که یه جمعیت در ۱۹۳۵ توی اتاقی در نیویورک کردن. منبع رو بذار روی <b>موسیقی</b>، دیگه اصلاً بحث نمی‌مونه. بعد β رو از ۱ تا ۸ قدم بده و ببین خطِ پایین تمیز می‌شه و خطِ بالا اصلاً تکون نمی‌خوره — چون AM اصلاً β نداره. پیچی نداره که بچرخونه. چیزی نداره که خرج کنه.",
      "s5.h21": "<span class=\"secnum\">06</span> پرتگاه",
      "s6.p1": "هر معامله‌ای توی مهندسی یه بندِ ریزنوشته ته‌ش داره، و بندِ این یکی حسابی تماشاییه.",
      "s6.p2": "برگرد به دو تا فلش. همهٔ چیزی که بالا گفتیم تکیه داشت به اینکه فلشِ نویز خیلی کوتاه‌تر از فلشِ سیگناله، طوری که فقط بتونه زاویه رو یه تکونی بده. بذار نویز اون‌قدر بزرگ بشه که قابلِ‌مقایسه بشه، اون‌وقت یه چیزِ ماهیتاً متفاوت شروع می‌شه: هرازگاهی، جمعِ این دوتا از <em>طرفِ اشتباهِ مبدأ</em> رد می‌شه. فِیزور به‌جای اینکه بلرزه، یه دورِ کامل می‌زنه. و آشکارسازی که اندازه می‌گیره زاویه چقدر عوض شده، این رو یه دورِ کاملِ اضافه گزارش می‌ده — یه ضربه، یه سوزن، یه <b>تق</b>.",
      "s6.p3": "تق‌ها متناسبِ هیچی نیستن. یه قلهٔ نویز که جای اشتباه بیفته، یه بنگِ تمام‌اندازه تولید می‌کنه، فارغ از اینکه بقیهٔ چیزها چقدر ساکت‌ان. هرچی سیگنال ضعیف‌تر می‌شه، بلندتر نمی‌شن؛ <em>پرتکرارتر</em> می‌شن، و تندتر از اونی می‌رسن که بهترشدنِ نرمِ معامله بتونه جذبشون کنه.",
      "s6.span1": "شکل ۴",
      "s6.span2": "نقطهٔ کار را بکش تا از لبه رد شود",
      "s6.span3": "سیگنال روی نویز، رسیده",
      "s6.note1": "صدا دارد. اول صدا را کم کن — تق‌ها بلندند.",
      "s6.cap1": "هر منحنی بیست‌وشش بار اجرای گیرنده‌ست در بیست‌وشش سطحِ نویز، اندازه‌گرفته‌شده و نه کشیده‌شده از روی فرمول — به همین دلیل خطِ FM یه‌کم ناصافه، و به همین دلیل زانو هرجا که خودش می‌افته می‌افته، نه جایی که کسی گذاشته باشدش. خاکستریِ خط‌چین AM ئه: کسل‌کننده، صاف، بی‌غافلگیری، و هرجا که اجازه داشته باشه بدتر. آبی FM ئه، که خیلی بالاتر ازش می‌ره — تا وقتی که از لبهٔ دنیا می‌افته. <b>روی شکل بکش و دو سرش گوش بده</b>، با <b>موسیقی</b> انتخاب‌شده: بالای زانو یه ضبطه، و زیرش همون ضبط هنوز هست، فقط زیرِ رگباری از تق‌هایی که توش نبودن. سرِ <span class=\"q\">25 dB</span>، FM نزدیکِ بیست دسی‌بل جلوئه. سرِ <span class=\"q\">15 dB</span> داره می‌بازه. β رو هرچی بالاتر بذاری جلوتر می‌افته، و — دقت کن — <b>پرتگاه زودتر می‌رسد.</b> نمی‌شود سکوت خرید بی‌آنکه لبه را هم بخری.",
      "s6.p4": "اون پرتگاه چیزی رو توضیح می‌ده که هر شنونده‌ای بی‌اینکه اسمش رو بلد باشه می‌دونتش. یه ایستگاهِ AMِ ضعیف یه صداست داخلِ هیس: زور می‌زنی، و بیشترش رو می‌گیری. یه ایستگاهِ FMِ ضعیف عالیه، عالیه، عالیه، بعد نیست. زوری در کار نیست. چیزی نیست که بشه براش زور زد.",
      "s6.p5": "همون تندیِ شیب یه اثرِ دیگه هم می‌سازه، و اسمِ این یکی رو مردم توی حرفِ روزمره هم به‌کار می‌برن. اگه دو تا ایستگاهِ FM روی یه فرکانس بیفتن و یکی حتی یه‌خرده قوی‌تر باشه، آشکارساز فِیزورِ قوی‌تر رو دنبال می‌کنه و ضعیف‌تره صرفاً وجود نداره. نه یه قاطی‌پاتی — <em>سکوت</em> از طرفِ بازنده. بهش می‌گن <b>اثرِ تسخیر</b>، و دلیلِ اینکه می‌شه بین دو تا شهر روی یه فرکانسِ FM رانندگی کنی و به‌جای یه آشغال‌بازی یه تحویلِ تمیز بشنوی همینه.",
      "s6.box1": "<b>و دقیقاً به همین دلیل هواپیماها هنوز AM به کار می‌برند.</b> کنترلِ ترافیکِ هوایی، روی <span class=\"q\">118–137 MHz</span>، در سالِ ۲۰۲۶ هم مدولاسیونِ دامنه‌ست، و این از سرِ غفلت نیست. توی AM، دو تا خلبان که هم‌زمان بفرستن یه جیغِ هترودینِ گوش‌خراش تولید می‌کنن و همه فوراً می‌فهمن که اتفاق افتاده. توی FM، قوی‌تره کانال رو تسخیر می‌کرد و ضعیف‌تره بی‌هیچ ردی محو می‌شد — از جمله، مثلاً، هواپیمایی که داره وضعیتِ اضطراری اعلام می‌کنه درست وقتی یکی دیگه داره یه مجوز رو تکرار می‌کنه. <em>عیبِ</em> قسمتِ اول اینجا ویژگیِ ایمنیه. هیچ‌کس قرار نیست عوضش کنه.",
      "s6.h21": "<span class=\"secnum\">07</span> مردی که پرید",
      "s7.p1": "آرمسترانگ FM رو از یه آنتنِ روی ساختمانِ امپایر استیت آزمایش می‌کرد، روی جایی که دوستِ قدیمیش دیوید سارنوف — که رئیسِ RCA بود — براش جور کرده بود. سال ۱۹۳۵ RCA ازش خواست دستگاه‌هاش رو جمع کنه. دکل رو برای تلویزیون لازم داشتن.",
      "s7.p2": "همون‌جاست که داستان می‌چرخه، و ارزشش رو داره که دقیق بگیم چرا. کسب‌وکارِ RCA همون AM بود: فرستنده، گیرنده، ثبت‌اختراع، شبکه‌های وابسته، کلِ دستگاهِ پخشِ رادیوییِ آمریکا. یه روشِ مدولاسیونِ بهتر برای اون‌ها فرصت نبود. یه رویدادِ منسوخ‌شدن بود که باید پولش رو هم به آرمسترانگ می‌دادن.",
      "s7.p3": "پس ایستگاهِ خودش رو ساخت. با پولِ خودش توی آلپاین، نیوجرسی، یه دکل زد، و تا ۱۹۴۰ ایستگاه‌های FM بود و گیرنده‌های FM بود و یه مخاطبِ کوچیک و پرشور که شنیده بود رادیو قرار بوده چه صدایی بده. و ژوئنِ ۱۹۴۵ کمیسیونِ FCC — بعد از جلساتی که RCA توشون سرسختانه، با استدلال‌های فنی‌ای که بعداً بی‌اعتبار شدن، گفت باندِ موجود مناسب نیست — FM رو از <span class=\"q\">42–50 MHz</span> برد بالا روی <span class=\"q\">88–108 MHz</span>.",
      "s7.p4": "همهٔ گیرنده‌های FMِ آمریکا، حدودِ نیم‌میلیون تا، یک روز با هم از کار افتادن. هر ایستگاهی باید کلِ تجهیزاتش رو عوض می‌کرد. مخاطبی که آرمسترانگ ده سال و بیشترِ ثروتش رو پای ساختنش گذاشته بود، با یه تصمیمِ اداری پاک شد.",
      "s7.p5": "نُه سالِ بعدی رو توی دادگاه گذروند. RCA تا اون‌موقع FM رو توی تلویزیون‌هاش هم به‌کار برده بود — صدای تلویزیون FM ئه، و همیشه بوده — و مدعی بود مهندس‌هاش خودشون مستقلاً اختراعش کردن. دعوای حقوقی هرچی از پولش مونده بود رو خورد و، به روایتِ همه، خودِ اون مرد رو هم. سی‌ویکمِ ژانویهٔ ۱۹۵۴ برای همسرش ماریون یادداشتی نوشت و بابتِ دردی که به او داده بود عذرخواهی کرد، و از پنجرهٔ آپارتمانِ طبقهٔ سیزدهم‌شان در نیویورک بیرون رفت.",
      "s7.p6": "ماریون آرمسترانگ پرونده‌ها را برداشت و تک‌تکشان را برد. RCA همان سال مصالحه کرد. آخری‌شان ۱۹۶۷ بسته شد. رأی‌ها یک‌صدا بودند و همه‌شان دیر، که تنها پایانی‌ست که این داستان می‌توانست داشته باشد.",
      "s7.box1": "دربارهٔ فیزیک حق با او بود، دربارهٔ صدا حق با او بود، دربارهٔ ثبت‌اختراع‌ها حق با او بود، و در دادگاه هم حق با او بود. هیچ‌کدام کوچک‌ترین فرقی در آنچه بر سرش آمد نکرد.",
      "s7.h21": "<span class=\"secnum\">08</span> پیچ‌ها هیچ‌وقت نرفتند",
      "s8.p1": "آخرش FM برد، کامل و بی‌سروصدا. و روشی که سال ۱۹۶۱ استریو رو توی خودش جا داد، خودش یه شکلِ جدا می‌ارزه، چون یکی از بهترین کارهای مهندسیِ سازگار-با-عقبه‌ست که کسی تا حالا کرده.",
      "s8.p2": "همون‌موقع میلیون‌ها رادیوی FMِ مونو توی خونه‌ها بود و هیچ‌کدومشون رو نمی‌شد جمع کرد. پس سیستمِ استریو طوری طراحی شد که اون‌ها اصلاً متوجه نشن. <b>L + R</b> رو توی باندِ صوتیِ معمولی بفرست، جایی که یه دستگاهِ مونو پیداش می‌کنه و به‌عنوانِ یه برنامهٔ مونوی کاملاً سالم پخشش می‌کنه. بعد <b>L − R</b> رو بالای باندِ صوتی قایم کن، روی یه زیرحاملِ سرکوب‌شده در <span class=\"q\">38 kHz</span> — همون DSB-SC، دقیقاً همون چیزی که قسمتِ اول گفت رادیوی پخشی هیچ‌وقت به‌کارش نمی‌بره، که اینجا دقیقاً <em>به این دلیل</em> به‌کار رفته که یه گیرندهٔ ساده نمی‌تونه آشکارش کنه. یه دستگاهِ استریو این دوتا رو با هم جمع و از هم کم می‌کنه و L و R رو پس می‌گیره. یه دستگاهِ مونو اون بالا اصلاً هیچی نمی‌شنوه.",
      "s8.span1": "شکل ۵",
      "s8.span2": "استریو، قاچاق‌شده از جلوی چشمِ یک میلیون رادیوی قدیمی",
      "s8.span3": "کانالِ چپ",
      "s8.span4": "کانالِ راست",
      "s8.lbl1": "<input type=\"checkbox\" id=\"mpxMono\"> با یک دستگاهِ مونوی ۱۹۵۹ گوش بده",
      "s8.cap1": "چیزی که واقعاً حامل رو مدوله می‌کنه صدا نیست — این کلِ این پشته‌ست، که بهش می‌گن سیگنالِ مرکب یا مالتی‌پلکس. خطِ خط‌چینِ روی <span class=\"q\">15 kHz</span> جاییه که یه گیرندهٔ قدیمی از شنیدن دست می‌کشید، و هرچی سمتِ راستشه طوری انتخاب شده که اون‌طرفِ همون خط زندگی کنه. سوزنِ کوچیکِ روی <span class=\"q\">19 kHz</span> همون <b>پایلوت</b> ئه: بالاتر از اونه که شنیده بشه، و تنها کارش اینه که به یه دستگاهِ استریو بگه استریو هست و ۳۸ کیلوهرتز کجاست. دو تا کانال رو متفاوت بذار، نوارِ تفاضل بزرگ می‌شه؛ برابرشون کن، کاملاً محو می‌شه — و دلیلِ اینکه یه برنامهٔ مونو روی یه ایستگاهِ استریو هیچ خرجِ اضافه‌ای نداره همینه. <b>تیکِ جعبه رو بزن</b> تا همون‌طور بشنویش که ۱۹۵۹ می‌شنید. برنامه هنوز سرِ جاشه. فقط دیگه توی دو جا نیست.",
      "s8.p3": "همین حقه دههٔ ۱۹۸۰ دوباره زده شد: RDS، همون چیزی که اسمِ ایستگاه رو روی نمایشگرِ ماشینت می‌آره، سوارِ یه زیرحاملِ دیگه روی <span class=\"q\">57 kHz</span> ئه — سه برابرِ پایلوت — و برای هرچی قبلش آمده به همون اندازه نامرئیه.",
      "s8.p4": "و بعد عجیب‌ترین زندگیِ پس‌ازمرگِ کلِ ماجرا. سال ۱۹۶۷ یه آهنگ‌ساز در استنفورد به اسم جان چاونینگ داشت با ویبراتو روی کامپیوتر ور می‌رفت، نرخِ مدولاسیون رو برد بالاتر از جایی که یه لرزش تبدیل به یه تُن می‌شه، و نوارهای کناری رو شنید. ریاضیاتِ آرمسترانگ رو دوباره کشف کرده بود، این‌بار به‌عنوانِ راهی برای ساختنِ صداهایی که کسی نشنیده بود. استنفورد لیسانسش رو داد به یاماها؛ DX7 سالِ ۱۹۸۳ عرضه شد و پرفروش‌ترین سینتی‌سایزرِ تاریخ شد. هر پیانوی الکتریکِ شیشه‌ایِ هر آلبومِ اون دهه J<sub>n</sub>(β) است.",
      "s8.p5": "و یه تصویر می‌مونه. سیگنالِ فرستاده‌شده رو نه به‌شکلِ یه موج، بلکه به‌شکلِ یه نقطهٔ واحد روی یه صفحه بکش — چقدرش هم‌گام با یه نوسان‌سازِ مرجعه، و چقدرش یک‌چهارمِ چرخه عقب‌تر. هر روشی که توی این دو مقاله آمده، راهِ متفاوتیه برای حرکت‌دادنِ همون یک نقطه.",
      "s8.span5": "شکل ۶",
      "s8.span6": "همه‌چیز، روی یک صفحه",
      "s8.p6": "<b>AM</b> نقطه رو روی یه خط جلوعقب می‌بره — کلِ اطلاعات توی فاصله از مبدأست. <b>PM</b> و <b>FM</b> فاصله رو ثابت نگه می‌دارن و روی کمان می‌چرخوننش. <b>SSB</b> با نرخِ ثابت دورِ یه دایره می‌بردش، و به همین دلیله که پوشی نداره که آشکار بشه. و <b>QAM</b> — هر مودم، هر لینکِ وای‌فای، هر سیگنالِ تلویزیونِ دیجیتال — دست از تظاهر به فرق‌داشتنِ این دوتا برمی‌داره و نقطه رو هرجا دلش بخواد می‌پرونه.",
      "s8.cap2": "یک نقطه، یک صفحه، و موجی که سمتِ راست ازش درمی‌آد. پیچ‌های بخشِ دومِ قسمتِ اول هنوز دقیقاً همون دو پیچ‌ان — چقدر دور، و از کدام طرف — و تنها چیزی که صد سال عوض کرده اینه که یه رادیو حالا نقطه رو مستقیم حرکت می‌ده، با یه جفت مبدلِ دیجیتال‌به‌آنالوگ، به‌جای اینکه برای هر ایده یه مدار بسازه. سهمِ آرمسترانگ، توی این تصویر، همین مشاهده‌ست که کمان جای خیلی امن‌تری برای نوشتنه تا شعاع.",
      "s8.box1": "طبیعت با دامنه می‌نویسد. پس تو ننویس.",
      "s8.span7": "قبلی",
      "s8.span8": "<a href=\"../hiding-a-voice-am/\">قسمت اول — AM و دردسرِ دامنه</a>. اینکه چرا یه صدا اصلاً حامل لازم داره، یه دیود و یه خازن به‌تنهایی چه می‌تونن بکنن، و اون دوسومِ دیگهٔ فرستنده کجا می‌ره.",
      "s8.h32": "منابع و خواندنِ بیشتر",
      "s8.li1": "J. R. Carson, “Notes on the Theory of Modulation,” <em>Proceedings of the IRE</em>, vol. 10, no. 1, Feb. 1922 — خودِ اثبات، و سرچشمهٔ قاعدهٔ پهنای‌باندی که اسمِ او را دارد.",
      ...
      "s8.li3": "L. Lessing, <em>Man of High Fidelity: Edwin Howard Armstrong</em>, Lippincott, 1956 — زندگی‌نامهٔ استاندارد، دو سال پس از مرگش نوشته شده و هوادارِ اوست.",
      "s8.li4": "T. Lewis, <em>Empire of the Air: The Men Who Made Radio</em>, HarperCollins, 1991 — دو فارست و سارنوف و آرمسترانگ کنارِ هم، که تنها شکلی‌ست که این داستان معنا می‌دهد.",
      "s8.li5": "J. M. Chowning, “The Synthesis of Complex Audio Spectra by Means of Frequency Modulation,” <em>Journal of the Audio Engineering Society</em>, vol. 21, no. 7, 1973.",
      "s8.li6": "A. B. Carlson, <em>Communication Systems</em>, 5th ed., McGraw-Hill — فصل‌های ۵ و ۱۰، برای طیفِ بسل، آستانه، و مدلِ تق‌هایی که پشتِ شکل ۴ است.",
      "s8.span9": "© ۲۰۲۶ حسن کشتکار · <span class=\"mono-label\">hkk.fyi</span>",
      "s8.span10": "ساخته‌شده با عشق <span class=\"heart\" aria-hidden=\"true\">♥</span> و هوش مصنوعی :)))",
      "meta.title": "قایم‌کردن یک صدا داخل یک موج — FM و بهای سکوت · hkk.fyi",
      "meta.description": "سال ۱۹۲۲ یک اثبات گفت مدولاسیون فرکانس بی‌فایده است، و اثبات درست بود. سال ۱۹۳۳ آرمسترانگ با انجامِ تنها کاری که به فکرِ کسی نرسیده بود به‌کارش انداخت: خرج‌کردنِ پهنای‌باند به‌جای صرفه‌جویی در آن. شش شکل زنده، سه تاش صدادار. قسمت دوم از دو.",
      "meta.og:title": "قایم‌کردن یک صدا داخل یک موج — FM و بهای سکوت",
      "meta.og:description": "توابع بسل، حاملی که ناپدید می‌شود، چرا پهن یعنی ساکت، پرتگاهی که ته معامله است، و مردی که به‌خاطرش از پنجره پرید.",
      "meta.og:image:alt": "یک فِیزور روی یک دایره که ردّش جمع و باز می‌شود، کنارِ عنوانِ مقاله.",
      "js.src.voice": "مصنوعی",
      "js.src.music": "موسیقی",
      "js.yes": "بله",
      "js.no": "نه",
      ...
      "js.beta.wide": "FMِ پخشی",
      "js.beta.ro_b": "شاخصِ مدولاسیون",
      "js.beta.ro_dev": "نوسانِ فرکانس",
      "js.beta.ro_j0": "ارتفاعِ حامل J₀(β)",
      "js.beta.ro_pairs": "جفت‌های کناریِ مهم",
      "js.beta.ro_carson": "پهنای‌باندِ لازم",
      "js.beta.ro_sum": "جمعِ همهٔ توان‌ها",
      "js.ph.bar1": "نوسانِ خودِ سیگنال",
      "js.ph.bar2": "چیزی که نویز می‌دزدد",
      "js.ph.click": "نویز حالا می‌تواند از آن‌طرفِ مبدأ رد شود — این یعنی تق",
      "js.ph.ro_swing": "سیگنال می‌چرخد به‌اندازهٔ",
      "js.ph.ro_noise": "نویز کجش می‌کند",
      "js.ph.ro_ratio": "نسبت",
      "js.ph.ro_enc": "احتمالِ ردشدن از حامل",
      "js.ph.never": "عملاً هیچ‌وقت",
      "js.quiet.l_am": "AM · خط‌چین = همان گیرنده در سکوت",
      "js.quiet.l_fm": "FM · خط‌چین = همان گیرنده در سکوت",
      "js.quiet.ro_g": "رسیده",
      "js.quiet.ro_bw": "پهنای‌باندِ FM، نسبت به AM",
      ...
      "js.cliff.below": "آن‌طرفِ لبه",
      "js.cliff.ro_g": "رسیده",
      "js.cliff.ro_am": "AM درمی‌آید",
      "js.cliff.ro_fm": "FM درمی‌آید",
      "js.cliff.ro_win": "FM جلوتر است به‌اندازهٔ",
      "js.cliff.ro_bw": "پهنای‌باندِ خرج‌شده، نسبت به AM",
      "js.cliff.ro_knee": "زانو می‌افتد روی",
      "js.cliff.ro_st": "تو کجایی",
      "js.mpx.xaxis": "فرکانس در سیگنالِ مرکب، کیلوهرتز",
      "js.mpx.sum": "L + R · برنامهٔ مونو",
      "js.mpx.pilot": "پایلوت",
      "js.mpx.dif": "L − R، روی حاملِ سرکوب‌شدهٔ ۳۸ کیلوهرتز",
      "js.mpx.rds": "RDS",
      "js.mpx.oldset": "هرچه یک گیرندهٔ ۱۹۵۹ می‌توانست بشنود",
      "js.mpx.deaf": "تا جایی که به دستگاهِ قدیمی مربوط است، هیچ‌کدامِ این‌ها وجود ندارد",
      "js.mpx.l_comp": "سیگنالِ مرکب، در زمان",
      "js.mpx.l_mono": "چیزی که دستگاهِ مونو پخش می‌کند · کم‌رنگ = کلِ مرکب",
      "js.mpx.ro_l": "چپ",
      "js.mpx.ro_r": "راست",
      "js.mpx.ro_sum": "L + R",
      "js.mpx.ro_dif": "L − R",
      ...
      "js.iq.n_fm": "روی یک کمان، با نرخِ متغیر",
      "js.iq.n_ssb": "دورِ یک دایره، یکنواخت",
      "js.iq.n_qam": "هرجا که دلش بخواهد",
