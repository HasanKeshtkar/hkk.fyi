...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      "s6.cap1": "Each curve is twenty-six runs of the receiver at twenty-six noise levels, measured rather than plotted from a formula — which is why the FM line is slightly ragged, and why the knee is where it lands on its own rather than where anybody put it. Dashed grey is AM: dull, straight, no surprises, worse everywhere it is allowed to be. Blue is FM, running far above it — until it falls off the world. <b>Drag along the picture and listen at each end.</b> At 25 dB, FM is twenty decibels ahead. At 15 dB it is losing. The higher you set β the further ahead it gets, and — look carefully — <b>the earlier the cliff arrives.</b> You do not get to buy quiet without also buying the edge.",
