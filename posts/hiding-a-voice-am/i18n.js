...
(function (global) {
  ...
  var DICT = {
    ...
    fa: {
      ...
      "start.p1": "بلند چیزی بگو. هر چه از دهانت بیرون آمد، هوایی بود که ثانیه‌ای چند صد بار لرزید. حالا اگر بخواهی همین را یک‌راست به آنتن بدهی، آنتنی به طول حدود <strong>۷۵ کیلومتر</strong> لازم داری. و فرض کن ساختی؛ آن‌وقت کل دنیا یک کانال بیشتر ندارد و همه هم‌زمان روی همان حرف می‌زنند.<br><br>پس کار عجیب‌تری می‌کنیم. موجی برمی‌داریم که آن‌قدر تند است که گوش نمی‌شنودش، و می‌گذاریم صدا هلش بدهد. صدا هیچ‌وقت سفر نمی‌کند؛ آنچه سفر می‌کند موجی به‌مراتب تندتر است که به شکل یک صدا <em>اذیت</em> شده.<br><br>برای اذیت کردنش دقیقاً سه راه هست. اولی همان است که زودتر از همه رسید، همان که با یک تیغ ریش‌تراشی زنگ‌زده هم می‌شود گرفتش، و همان که هر بار از یک رعدوبرق شکست می‌خورد. <b>پیش‌زمینهٔ رادیو لازم نداری.</b> هر شکلی که پایین می‌بینی زنده است: بکشش، خرابش کن، و هر جا علامت بلندگو دیدی گوش بده.",
      ...
      "start.li1": "صدا هم برای تابش شدن کند است و هم برای شریکی بودن شلوغ. پس سوارش می‌کنیم: یک موج تند و حوصله‌سربر راه را می‌رود، و صدا فقط تصمیم می‌گیرد که <em>آن موج تند چه شکلی باشد</em>.",
      "start.li2": "یک موج سینوسی دقیقاً سه چیز در اختیارت می‌گذارد: چقدر بلند، چقدر تند، و کجای چرخه‌اش. یکی را انتخاب کن و با پیام تکانش بده؛ نوعی رادیو اختراع کرده‌ای.",
      "start.li3": "ارتفاعش را تکان بدهی، پیام مثل یک <b>پوش</b> روی نوک حامل کشیده می‌شود، و یک دیود و یک خازن می‌توانند دوباره بخوانندش. گیرنده واقعاً همین‌قدر است و بس — و AM به همین دلیل زودتر از بقیه برد.",
      "start.li4": "اما صورت‌حساب دو بار می‌آید. سر مدولاسیون کامل، <b>دوسوم توان فرستنده در حاملی است که هیچ چیزی حمل نمی‌کند</b>، و همان‌جا هم می‌ماند تا گیرنده بتواند احمق بماند.",
      "start.li5": "صورت‌حساب دوم کشنده است. رعدوبرق و موتور و خورشید همه با دامنه می‌نویسند، و پیام AM <em>خودش</em> دامنه است. آشکارساز از هم تشخیصشان نمی‌دهد، پس هر دو را تحویل می‌دهد. <b>اسمش استاتیک است، و از داخل AM هیچ چاره‌ای ندارد.</b>",
      ...
      "start.li7": "<a href=\"#s2\">یک موج سینوسی دقیقاً سه پیچ دارد</a>",
      "start.li8": "<a href=\"#s3\">پیام سوار پوش می‌شود</a>",
      "start.li9": "<a href=\"#s4\">یک دیود، یک خازن، و یک تیغ ریش‌تراشی</a>",
      "start.li10": "<a href=\"#s5\">صورت‌حساب یک گیرندهٔ ارزان</a>",
      "start.li11": "<a href=\"#s6\">دو نوار کناری، و یک تغییر قیافهٔ اضافه</a>",
      ...
      "s1.p2": "آن مرد رجینالد فسندن بود و از برنت‌راک می‌فرستاد. یکی از قشنگ‌ترین قصه‌های تاریخ مهندسی است، و انصاف حکم می‌کند رک بگوییم که سند و مدرکِ همان شبِ بخصوص لاغر است: تمام ماجرا به نامه‌ای برمی‌گردد که فسندن بیست‌وشش سال بعد نوشت، و تا امروز هیچ‌کس دفترچهٔ هیچ کشتی‌ای را پیدا نکرده که چیزی از آن گفته باشد. اما در خود دستاورد شکی نیست. فسندن واقعاً صدا را با رادیو فرستاد، سال‌ها زودتر از آنکه کس دیگری قانع‌کننده از پسش بربیاید؛ و دستگاهی که با آن این کار را کرد یک هیولا بود: یک آلترناتور، یعنی عملاً همان ژنراتور نیروگاه، ساختهٔ ارنست الکساندرسون در جنرال الکتریک، که آن‌قدر تند می‌چرخید که به‌جای برق شهر یک موج رادیویی یکنواخت بسازد.",
      "s1.p3": "و همین‌جا سؤالی پیش می‌آید که معمولاً کسی نمی‌پرسد: اصلاً چرا آن آلترناتور لازم بود؟ میکروفون که همین حالا هم صدا را به یک ولتاژ لرزان تبدیل می‌کند. چرا میکروفون را یک‌راست به آنتن نبندیم؟",
      "s1.p4": "دو دلیل دارد، و اولی همان است که همه نقل می‌کنند. آنتن باید کسر آبرومندی از موجی باشد که تابشش می‌کند، و عدد معمول یک‌چهارم است. یک تُن <span class=\"q\">1 kHz</span> طول موجش ۳۰۰ کیلومتر است، و یک‌چهارمش می‌شود <span class=\"q\">75 km</span> مس که وسط یک زمین ایستاده باشد — آن هم فقط برای بم‌ترین نت صدایت. کسی چنین چیزی نمی‌سازد.",
      "s1.p5": "دلیل دوم بدتر است، و در واقع همان است که تکلیف طراحی را روشن می‌کند. فرض کن آنتن را ساختی و فرض کن همه ساختند. آن‌وقت صدای هر آدمی روی زمین به هر گیرنده‌ای روی زمین می‌رسد، همه در همان چند صد هرتز و همه روی هم. و هیچ فیلتری، هیچ پیچ تنظیمی، هیچ چیزی نمی‌تواند از هم جداشان کند، چون در <em>جاهای</em> مختلف نیستند؛ همه دقیقاً یک جا هستند. باند پایه یکی بیشتر نیست، و جای دو نفر در آن نمی‌شود.",
      ...
      "s1.cap1": "سه ایستگاه. <b>«بدون حامل» را بزن</b> و می‌بینی هر سه در همان چند کیلوهرتز تلنبار شده‌اند؛ ردیف پایین چیزی است که یک میکروفون می‌شنید، و هیچ کاری نمی‌شود با آن کرد که این سه را از هم سوا کند. حالا <b>«روی سه حامل» را بزن</b>: همان سه ایستگاه ناگهان در سه جای مختلف‌اند. بعد <b>هر جای تصویر را بکش</b> تا دیال جابه‌جا شود. آن تپهٔ سایه‌دار فیلتر گیرندهٔ توست و ردیف پایین چیزی است که از بلندگو درمی‌آید، در برابر خط‌چینِ آنچه فرستاده شده. بین دو ایستگاه پارک کن؛ ساکت می‌شود. پهنای‌باند را که از حدود <span class=\"q\">10 kHz</span> بالاتر ببری، صدای همسایه هم می‌آید تو. و اگر منبع را روی <b>«موسیقی»</b> بگذاری، سه ایستگاه می‌شوند همان ضبط با سه سرعت مختلف — و همان لحظه تصویر از خط درمی‌آید و نوار می‌شود، چون یک ضبط طیف خطی ندارد که کشیده شود.",
      "s1.sum1": "یک لحظه — «پهنای‌باند» یعنی چه؟",
      "s1.p8": "یک سیگنال هیچ‌وقت روی یک فرکانس نیست. صدا بسته‌ای از فرکانس‌هاست که با هم می‌آیند: غرش بم تارهای صوتی، هیس همخوان‌ها، و هر چه میان این دو. <b>پهنای‌باند یعنی این بسته چقدر پهن است</b>؛ فاصلهٔ کف‌ترین فرکانسش تا بالاترین، بر حسب هرتز، مثل بقیهٔ چیزها.",
      "s1.p9": "و اهمیتش از آنجاست که همان چیزی است که پولش را می‌دهی. یک ایستگاه صاحب یک فرکانس نیست، صاحب یک <em>نوار</em> از فرکانس‌هاست، و آن نوار باید دست‌کم به پهنای بسته‌ای باشد که حملش می‌کند وگرنه سر پیام قیچی می‌شود. حرف هر دو قسمت این مقاله هم همین است: هر ایده چقدر نوار لازم دارد، و در عوضش چه چیزی دستت را می‌گیرد.",
      "s1.sum2": "چرا عددهای این شکل‌ها این‌قدر کوچک‌اند؟",
      "s1.p10": "یک ایستگاه AM واقعی جایی حوالی یک مگاهرتز می‌نشیند، ولی حامل‌های شکل‌های پایین روی شانزده و سی‌ودو و چهل‌وهشت <em>کیلو</em>هرتزند؛ حدود پنجاه برابر پایین‌تر. این عمدی است و برای آن است که شکل‌ها بتوانند خودشان را پخش کنند: سیگنال باید در محدوده‌ای جا بگیرد که یک کارت صدا از پسش برمی‌آید تا تو بشنوی چه بلایی سرش آمده.",
      "s1.p11": "جز این چیزی عوض نشده. هر <em>نسبتی</em> — حامل به پیام، ایستگاه به همسایه، سیگنال به نویز — همان نسبتی است که در یک باند واقعی هست، و حساب‌وکتاب فرقش را نمی‌فهمد. مثل همان رادیو ببینش، فقط آن‌قدر کند پخش شده که بشود گوشش داد.",
      "s1.p7": "و کل توجیه پیچیده بودن رادیو همین است. آن موج تند پیام نیست و هیچ‌وقت نبوده؛ یک <em>جا برای ایستادن</em> است.",
      "s1.h21": "<span class=\"secnum\">02</span> یک موج سینوسی دقیقاً سه پیچ دارد",
      "s2.p1": "این خودِ حامل است، کامل نوشته‌شده. حوصله‌سربرترین چیز این مقاله است و باقی همه‌چیز نتیجهٔ همین است:",
      "s2.eqlbl1": "حامل",
      "s2.p2": "سه حرف که اجازه داری به آن‌ها دست بزنی: <b>A</b>، یعنی چقدر بلند است؛ <b>f<sub>c</sub></b>، یعنی چقدر تند می‌رود؛ و <b>φ</b>، یعنی لحظه‌ای که شروع به نگاه کردن می‌کنی کجای چرخه‌اش است. کل منو همین است. چیز دیگری در یک موج سینوسی نیست که عوض شود، و همین یعنی دقیقاً سه نوع مدولاسیون داریم و هر روشی که تا حالا وجود داشته یکی از این سه است یا ترکیبی از آن‌ها.",
      "s2.li1": "<b>A</b> را تکان بدهی، می‌شود <b>مدولاسیون دامنه</b> — همان AM، و موضوع بقیهٔ این مقاله.",
      "s2.li2": "<b>f<sub>c</sub></b> را تکان بدهی، می‌شود <b>مدولاسیون فرکانس</b> — همان FM، که قسمت دوم است.",
      "s2.li3": "<b>φ</b> را تکان بدهی، می‌شود <b>مدولاسیون فاز</b> — همان PM، که تقریباً هیچ‌کس با آن پخش نمی‌کند و تقریباً هر رادیوی دیجیتالی از آن استفاده می‌کند.",
      "s2.p3": "آن دو تای آخر خیلی نزدیک‌تر از چیزی هستند که به نظر می‌آیند. فرکانس یعنی فاز دارد چقدر تند عوض می‌شود؛ پس فاز را که هل بدهی، فرکانس هم به‌عنوان عارضهٔ جانبی می‌لرزد، و فرکانس را که هل بدهی، فاز هم درجا در می‌رود. FM و PM یک حیوان‌اند که از دو زاویه عکس گرفته شده، و مهندس‌ها هر دو را زیر نام <em>مدولاسیون زاویه</em> جمع می‌کنند. آنکه جدا می‌ایستد AM است، و همین فرق دلیل دو قسمتی بودن این مقاله است.",
      "s2.span1": "شکل ۲",
      "s2.span2": "یک پیام، سه پیچ",
      "s2.span3": "چقدر هل بدهد",
      "s2.p4": "ردیف بالا پیام است. سه ردیف زیرش همان یک حامل‌اند که با همان یک پیام هل داده می‌شوند، این بار از هر کدام از سه پیچ. آن خط خاکستری کم‌رنگ پشت هر کدام هم باز خود پیام است، تا بفهمی چه کسی دارد چه می‌کند.",
      "s2.p5": "پیام <b>«مربعی»</b> را امتحان کن. AM می‌شود یک جعبه. FM می‌شود دو سوت که پشت سر هم عوض می‌شوند — که نام هم دارد، <em>کلیدزنی شیفت فرکانس</em>، و هر مودم و هر پیجر و هر ریموت درِ پارکینگی که تا حالا ساخته شده همین‌طور کار می‌کند. PM هم فقط می‌پرد.",
      "s2.cap1": "هیچ‌کدام از این‌ها فرستندهٔ متفاوتی نیست؛ یک نوسان‌ساز است با سه پیچ مختلف. دقت کن که AM زمان‌بندی موج را مو به مو منظم نگه می‌دارد و فقط ارتفاعش را عوض می‌کند، ولی FM و PM ارتفاع را مو به مو ثابت نگه می‌دارند و فقط با زمان‌بندی ور می‌روند. <b>این را نگه دار.</b> کل قصهٔ قسمت دوم همین است.",
      "s2.h21": "<span class=\"secnum\">03</span> پیام سوار پوش می‌شود",
      "s3.p1": "پیچ اول را بردار. می‌خواهی ارتفاع حامل دنبال پیام بیاید، پس کار بدیهی این است که در هم ضربشان کنی: حامل ضرب در پیام. این تا حدی هم جواب می‌دهد و نامی هم دارد که بعداً سراغش برمی‌گردیم. اما چیزی که یک ایستگاه پخش می‌فرستد این نیست، و دلیلش پرعاقبت‌ترین تصمیم مهندسی کل این مقاله است.",
      "s3.p2": "آنچه ایستگاه واقعاً می‌فرستد این است:",
      "s3.eqlbl1": "مدولاسیون دامنه",
      "s3.p3": "<b>x(t)</b> پیام است، مقیاس‌شده طوری که بین −۱ و +۱ نوسان کند. <b>m</b> همان <em>شاخص مدولاسیون</em> است، یعنی چقدر هل می‌دهی: از ۰، که اصلاً پیامی در کار نیست و فقط یک حامل لخت داری، تا ۱، که پیام ارتفاع حامل را از دو برابر تا هیچ می‌برد. و کل حقه در همان <b>۱</b>ی است که جلوی پیام نشسته.",
      "s3.sum1": "یک لحظه — «پوش» یعنی چه؟",
      "s3.p4": "یک موج تند و پرلرزش بکش. حالا بدون اینکه قلم را برداری، خطی نرم از روی نوک قله‌هایش رد کن. آن خط پوش است. چیز واقعی‌ای نیست که با ولت‌متر در یک لحظه بشود اندازه گرفت — در هر لحظه فقط خود موج را داری — اما اگر موج خیلی تندتر از آن خط باشد، خط برای چشم غیرقابل‌انکار است. و معلوم شد که برای یک دیود هم غیرقابل‌انکار است.",
      "s3.p5": "همان <span class=\"q\">1 + m·x(t)</span>ی که در معادلهٔ بالاست دقیقاً همین خط است. کار AM این است که پیامت را روی نوک یک حامل بکشد و امیدوار باشد آن سر خط دوباره ردش را بگیرد.",
      "s3.p6": "به خاطر همان ۱، تا وقتی m زیر ۱ بماند پوشِ <span class=\"q\">1 + m·x(t)</span> اصلاً نزدیک صفر نمی‌شود؛ فقط دور یک وسطِ راحت بالا و پایین نفس می‌کشد. پیام به شکل یک فرم روی نوک حامل خوانا می‌ماند، و هر چیزی که بتواند نوک حامل را پیدا کند، پیام را پیدا کرده است.",
      "s3.box1": "آن حامل آنجا نیست که اطلاعات را ببرد. آنجاست که اطلاعات را چیزی بتواند بخواند که حتی نمی‌داند فاز یعنی چه.",
      "s3.h21": "<span class=\"secnum\">04</span> یک دیود، یک خازن، و یک تیغ ریش‌تراشی",
      "s4.p1": "این کل گیرنده است. یک دیود، که جریان را از یک طرف رد می‌کند و از طرف دیگر نه؛ و یک خازن، که از راه دیود تند شارژ می‌شود و بعد آرام از راه یک مقاومت خالی می‌شود. این‌ها را بگیر جلوی یک سیگنال AM: خازن تا هر قله بالا می‌رود، بعد کمی شل می‌شود، بعد قلهٔ بعدی دوباره هلش می‌دهد بالا. آنچه شل‌شدن به شل‌شدن می‌کشد همان پوش است، و پوش همان پیام.",
      "s4.p2": "این ساده‌سازی برای مقاله نیست؛ خودِ خودِ مدار است. منبع تغذیه هم ندارد و با انرژی خود موج رادیویی کار می‌کند. در دههٔ ۱۹۲۰ بچه‌ها همین را سر میز صبحانه می‌ساختند: یک سیم‌پیچ، یک خازن متغیر، و تکه‌ای بلور گالن که با سیمی فنری به آن سیخونک می‌زدند. نام آن سیم «سبیل گربه» بود، و پیش از آنکه کسی دیود بسازد، دیود بود.",
      "s4.p3": "در جنگ جهانی دوم سربازها همین را از هر چه دم دستشان بود می‌ساختند. نسخهٔ معروفش با یک تیغ ریش‌تراشی آبی‌شده و یک مغز مداد کار می‌کرد: لایهٔ اکسید روی فولاد، اگر با گرافیت جای درستش را پیدا کنی، یک اتصال یکسوکنندهٔ قابل‌قبول می‌شود. به آن‌ها می‌گفتند رادیوی سنگر. نه باتری، نه لامپ، نه چیزی که لازم باشد از انبار بگیری، نه چیزی که بشود از تو گرفت. این همان چیزی است که AM با آن حامل حرام‌شده‌اش خرید، و واقعاً چیز عظیمی خریده.",
      "s4.p4": "مدار یک جور خراب می‌شود، و آن یک جور هم حسابی تماشایی است. دیود از علامت سر درنمی‌آورد و فرقی میان پوش <span class=\"q\">−0.3</span> و پوش <span class=\"q\">+0.3</span> نمی‌گذارد؛ برای یک یکسوکننده هر دو یک مقدار موج‌اند. پس همان لحظه که m را از ۱ رد کنی و پوش بخواهد زیر صفر برود، آشکارساز دنبالش پایین نمی‌رود. <em>تایش می‌کند بالا</em>، و همان تا را به‌عنوان پیام گزارش می‌دهد.",
      "s4.span1": "شکل ۳",
      "s4.span2": "زیادی هلش بده، پاره می‌شود",
      "s4.span3": "شاخص مدولاسیون",
      "s4.note1": "صدا دارد. اول صدا را کم کن.",
      "s4.cap1": "بالا: آنچه از فرستنده بیرون می‌رود، با پوشش کشیده‌شده روی آن. پایین: آنچه یک آشکارساز واقعیِ دیود و خازن پس می‌گیرد، در برابر خط‌چینِ آنچه یک آشکارساز فرضی — که علامت را می‌دید — می‌گرفت. زیر <b><span class=\"q\">m = 1</span></b> این دو روی هم می‌افتند و کمتر از یک درصد فاصله می‌ماند؛ همان ته‌مانده هم شل شدن خازن است بین قله‌های حامل، و بهترین چیزی است که از این مدار درمی‌آید. حالا m را از ۱ رد کن: دو نیمهٔ پوش از هم رد می‌شوند و ردی که پس گرفته می‌شود دیگر پیام نیست، قدرمطلق پیام است. <b>دکمهٔ شنیدن را بزن و m را از روی ۱ رد کن</b>؛ آن لحظه که دیگر شبیه موسیقی نیست و شبیه خرابی است، اصلاً ظریف نیست. حالت <b>«موسیقی»</b> هم یک ضبط واقعی است که به اندازهٔ جای یک کانال AM باریک شده — و به همین دلیل، پیش از آنکه بلایی سرش بیاید هم شبیه رادیوست.",
      "s4.p5": "به همین دلیل است که هر استودیوی پخشی روی زمین یک مدولاسیون‌متر دارد با یک خط قرمز روی آن، و به همین دلیل است که کارِ سواری کردن روی همان عقربه — بلندها را درست زیر خط نگه داشتن و نگذاشتن که آرام‌ها در نویز گم شوند — یک شغل بود. کم هل بدهی، دامنه را دور ریخته‌ای؛ زیاد هل بدهی، داری یک تا را پخش می‌کنی.",
      "s4.h21": "<span class=\"secnum\">05</span> صورت‌حساب یک گیرندهٔ ارزان",
      "s5.p1": "حالا برویم سراغ فاکتور. آن ۱ ثابتِ توی معادله حاملی است که تمام‌قد و تمام‌وقت حاضر است، چه کسی حرف بزند چه نزند. تکان نمی‌خورد و ذره‌ای اطلاعات حمل نمی‌کند؛ می‌توانی هزار سال آینده‌اش را بی‌خطا پیش‌بینی کنی. و بزرگ‌ترین چیزی است که فرستنده دارد پولش را می‌دهد.",
      "s5.p2": "برای یک تُن تک که تا ته مدوله شده — یعنی m = 1 — حساب دقیقاً درمی‌آید <b>دوسوم توان فرستاده‌شده در حامل</b> و یک‌سوم میان دو نوار کناری که واقعاً پیام را دارند. نیم مگاوات فرستنده، و جایی بالای سیصد کیلووات از آن خرج تابش نتی می‌شود که هیچ‌وقت عوض نمی‌شود.",
      "s5.span1": "شکل ۴",
      "s5.span2": "توان واقعاً کجا می‌رود",
      "s5.span3": "شاخص مدولاسیون",
      "s5.p3": "پیام را از تُن بگذار روی صدا و ببین سهم مفید، سر همان شاخص مدولاسیون، چطور از کف در می‌رود. یک تُن تمام وقتش را سر نوسان کامل می‌گذراند، اما یک صدا بیشتر وقتش نزدیک صفر است و فقط هرازگاهی به سقف می‌خورد — و همان سقف است که m را تعیین می‌کند.",
      "s5.cap1": "آن میله توان فرستنده است، تقسیم‌شده میان حامل (خاکستری، بی‌مصرف) و نوارهای کناری (آبی، همان پیام). منحنی زیرش سهم آبی است در برابر اینکه چقدر هل می‌دهی. سر <b><span class=\"q\">m = 1</span></b> با یک تُن، منحنی به خط‌چینِ یک‌سوم می‌خورد و همان‌جا می‌ایستد. آن ناحیهٔ سایه‌دار بعد از <span class=\"q\">m = 1</span> جایی است که بازده همچنان بهتر می‌شود و سیگنال دیگر قابل بازیابی نیست — که معامله‌ای نیست کسی اجازهٔ کردنش را داشته باشد. صدای واقعی رادیو بازدهش به‌طور متوسط یکی دو درصد است.",
      ...
      "s5.h21": "<span class=\"secnum\">06</span> دو نوار کناری، و یک تغییر قیافهٔ اضافه",
      "s6.p1": "تا اینجا همه‌چیز در زمان بود؛ موج‌هایی که بالا و پایین می‌روند. حالا همان سیگنال را از آن سو نگاه کن، بر حسب فرکانس، که دعوا در واقع آنجا فیصله پیدا می‌کند.",
      "s6.p2": "دو موج سینوسی را در هم ضرب کن؛ هیچ‌کدامشان را تحویل نمی‌گیری، بلکه دو تای تازه می‌گیری: یکی روی جمع فرکانس‌ها و یکی روی تفاضلشان. همین یک حقیقت موتور کل رادیوست. یک تُن ۱ کیلوهرتزی را به یک حامل ۱ مگاهرتزی بده: نه چیزی روی ۱ کیلوهرتز می‌نشیند و نه چیز اضافه‌ای روی ۱ مگاهرتز؛ به‌جایش یک جفت تُن تازه روی ۹۹۹ و ۱۰۰۱ کیلوهرتز سبز می‌شود، دو طرف حامل، مثل انعکاس هم.",
      "s6.eqlbl1": "تنها مثلثات این مقاله",
      "s6.p3": "آن دو تُن تازه <b>نوارهای کناری</b>اند. هر نت پیام جفت خودش را می‌سازد، پس صدایی که تا ۴٫۵ کیلوهرتز بالا می‌رود هر طرف لکه‌ای <span class=\"q\">4.5 kHz</span> نوار کناری می‌سازد و ایستگاه در کل <span class=\"q\">9 kHz</span> جا می‌گیرد. این اتفاقی نیست: به همین دلیل کانال‌های AM در بیشتر دنیا ۹ کیلوهرتز و در قارهٔ آمریکا ۱۰ کیلوهرتز از هم فاصله دارند، و به همین دلیل رادیوی AM صدایش خفه است. نقشهٔ باند، زیرِ صدایت را سال ۱۹۲۸ قیچی کرد.",
      "s6.p4": "و حالا بخش معذب ماجرا. آن دو نوار کناری آینهٔ یکدیگرند؛ بالایی و پایینی <em>یک اطلاعات</em> را دارند، دو بار. یعنی داری پول یک نسخهٔ تکراری را می‌دهی، به‌اضافهٔ حاملی که هیچ نمی‌گوید. از هر چه فرستنده در هوا می‌ریزد، فقط حدود یک‌ششم توان و نصف پهنای‌باند دارد کاری می‌کند که بدون خودش نمی‌شد.",
      "s6.span1": "شکل ۵",
      "s6.span2": "چیزها را بردار و ببین کجا می‌شکند",
      "s6.span3": "زیر و بمی پیام",
      "s6.cap1": "ردیف بالا طیف است و ردیف پایین همان سیگنال در زمان، با شکلی که یک دیود دنبالش می‌کند کشیده‌شده روی آن. از <b>AM</b> شروع کن و زیر و بم را بکش؛ نوارهای کناری از حامل دور می‌شوند و برمی‌گردند. حالا برو روی <b>DSB-SC</b>: خط حامل غیب می‌شود و پوش هنوز هست، ولی پیامِ <em>تاشده</em> است، یعنی همان خرابیِ اضافه‌مدولاسیونِ شکل ۳، این بار برای همیشه. بعد با یک تُن تک برو روی <b>SSB</b> و ردیف پایین را نگاه کن: <b>پوش یک خط صاف است.</b> همه‌چیز سر جایش هست، اما حالا در زمان‌بندی است، و یک دیود دربارهٔ زمان‌بندی هیچ نظری ندارد.",
      "s6.p5": "پس بردارشان. حامل را بکش، می‌شود <b>DSB-SC</b>، دو نوار کناری با حامل سرکوب‌شده، و کل توان می‌رود توی پیام. یکی از نوارهای کناری را هم بکش، می‌شود <b>SSB</b>: نصف پهنای‌باند، و تمام توان مفید. جان کارسون، مهندسی در AT&amp;T که همین نزدیکی‌ها آدم‌بدِ قسمت دوم می‌شود، تک‌نوار کناری را سال ۱۹۱۵ ثبت کرد، و تا ۱۹۲۷ در AT&amp;T با آن مکالمهٔ تلفنی نیویورک–لندن رد می‌کردند.",
      "s6.p6": "و رادیوی پخشی صد سال تمام، عمداً، هر دو را نادیده گرفت. چون ببین برای گرفتنشان باید چه کنی. حامل که نباشد، دیگر هیچ مرجعی نمانده که چیزی را با آن بسنجی، پس گیرنده باید خودش یکی <em>بسازد</em>: نوسان‌سازی از آنِ خودش، روی فرکانس فرستنده، آن‌قدر دقیق کوک که صدای بازسازی‌شده شبیه اردک از آب درنیاید. این دیگر یک سنگ و یک سیم خم‌شده نیست؛ این یعنی یک نوسان‌ساز پایدار در هر خانه، سال ۱۹۳۰.",
      ...
      "s8.span1": "بعدی",
      "s8.span2": "<a href=\"../hiding-a-voice-fm/\">قسمت دوم — FM و بهای سکوت</a>. توابع بسل، حاملی که غیب می‌شود، پرتگاهی که ته معامله است، و مردی که به خاطرش از پنجره پرید.",
      ...
      "s8.li2": "J. R. Carson, “Notes on the Theory of Modulation,” <em>Proceedings of the IRE</em>, vol. 10, no. 1, Feb. 1922 — نوارهای کناری، و همان استدلالی که در قسمت دوم جوابش داده می‌شود.",
      ...
      "s8.li4": "A. B. Carlson, <em>Communication Systems</em>, 5th ed., McGraw-Hill — فصل‌های ۴ و ۱۰، برای نظریهٔ مدولاسیون و نویزی که پشت تک‌تک شکل‌های اینجاست.",
      ...
      "meta.description": "صدا چند صد هرتز است و آنتنش هفتادوپنج کیلومتر می‌شد، پس پنهانش می‌کنیم در چیزی تندتر. راهنمایی ساده و تعاملی برای مدولاسیون دامنه، با شکل‌هایی که می‌شود کشیدشان و شنیدشان — بدون پیش‌زمینهٔ رادیو. قسمت اول از دو.",
      "meta.og:title": "پنهان کردن یک صدا در یک موج — AM و دردسر دامنه",
      "meta.og:description": "شش شکل تعاملی، سه تاش صدادار. چرا رادیو حامل لازم دارد، یک دیود و یک خازن به‌تنهایی چه می‌کنند، و چرا استاتیک برنده می‌شود.",
      "meta.og:image:alt": "یک حامل مدوله‌شده در دامنه، با پوش کشیده‌شده، کنار عنوان مقاله.",
      "js.src.voice": "مصنوعی",
      "js.src.music": "موسیقی",
      "js.yes": "بله",
      "js.no": "نه",
