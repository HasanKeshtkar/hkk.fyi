/* ============================================================
   Every word this page can say, in both languages.

   Edit the Persian right here — these strings are the source and there is no
   build step between this file and the page. Keys say where they sit: s3.p2 is
   the second paragraph of section 3, s6.figcaption1 the caption under section
   6's figure, and js.* is anything the figures write themselves.

   Two rules the Persian side keeps to:
     · numbers in running prose are Persian — ۲۵ کیلومتر، ۳۳٫۳٪
     · numbers glued to a Latin unit, or sitting inside a formula, stay Latin —
       10 kHz, m = 1, s(t) = Ac[1 + m·x(t)]·cos(2πfc t)

   The site header and footer keep their left-to-right layout in both
   languages, so the logo, the language switch and the theme button never move.
   ============================================================ */
(function (global) {
  'use strict';
  var LANG_KEY = 'hkk-lang', SCROLL_KEY = 'hkk-scroll';
  var DICT = {
    en: {
      "fig1.n": "FIG 1",
      ...
      "js.f7.v0": "Between stations. The filter is sitting on empty spectrum, so nothing reaches the detector but noise.",
      ...
      "js.f7.v2b": ". Their sidebands both reach the detector and you hear them mixed together. ",
      ...
      "js.f7.v2a": "Two stations inside one window: ",
    ...
    fa: {
      ...
      "fig2.n": "شکل ۲",
      "fig2.t": "حامل شکل پیام را به خودش می‌گیرد",
      "fig3.n": "شکل ۳",
      "fig3.t": "آن‌قدر بالا ببر تا بشکند",
      "fig4.n": "شکل ۴",
      ...
      "s3.chk1": "پوش را بکش",
      "s7.chk1": "با پیام اصلی مقایسه کن",
      ...
      "nav.cv": "رزومه",
      "nav.contact": "تماس",
      "start.monolabel1": "مقاله · سیگنال و مخابرات · ~۱۴ دقیقه · ۷ شکل زنده",
      "start.h1": "مدولاسیون AM",
      "start.p1": "میکروفون به شما سیگنالی می‌دهد که چند هزار بار در ثانیه بالا و پایین می‌رود. موجی که می‌تواند یک شهر را رد کند، چند میلیون بار در ثانیه نوسان می‌کند. مدولاسیون همان کاری است که اولی را سوار دومی می‌کند.<br><br>این نوشته درباره‌ی ساده‌ترین راهش است: <b>مدولاسیون دامنه</b>. شروع از همین‌جا درست است، چون هر روش دیگری در نهایت شکل دیگری از همین یک فکر است — یک موج پرفرکانسِ یکنواخت بردار، و بگذار پیام چیزی از آن را عوض کند.<br><br>فقط کافی است بدانید موج سینوسی چیست. <b>هر شکلی که پایین‌تر می‌بینید زنده است</b> — بکشیدش، خرابش کنید، ببینید چه می‌شود.",
      ...
      "start.li1": "صدا را نمی‌شود به شکل صدا فرستاد. در فرکانس‌های گفتار، آنتنِ درست‌وحسابی <b>ده‌ها کیلومتر</b> طول می‌خواهد، و از آن گذشته همه‌ی فرستنده‌های دنیا در یک باند و روی هم می‌افتند.",
      ...
      "start.li4": "شاخص مدولاسیون را زیر یک نگه دارید، <b>m ≤ 1</b>. بالاتر از یک، پوش از صفر رد می‌شود و تا می‌خورد، و دیگر نمی‌شود پیام را تمیز بیرون کشید.",
      "start.li5": "در فرکانس، پیام بالا می‌رود و به‌صورت دو <b>باند کناری</b> قرینه کنار حامل می‌نشیند. یعنی AM <b>دو برابر</b> پهنای باند پیام جا می‌گیرد.",
      "start.li6": "خود حامل هیچ اطلاعاتی حمل نمی‌کند، ولی دست‌کم دوسوم توان را می‌برد. AM این هزینه را می‌دهد تا گیرنده‌اش فقط <b>یک دیود، یک مقاومت و یک خازن</b> باشد.",
      ...
      "s1.p3": "آنتن وقتی خوب تابش می‌کند که طولش کسر قابل‌توجهی از طول موج سیگنالی باشد که به آن می‌دهید، و هدف معمول یک‌چهارم طول موج است. طول موج هم مستقیم از فرکانس درمی‌آید:",
      "s1.lbl1": "طول موج",
      ...
      "s1.figcaption1": "مقیاس لگاریتمی است، یعنی هر نشانه ده برابر نشانه‌ی قبلی. اسلایدر را از تُن صدا در انتهای چپ تا وای‌فای در انتهای راست بکشید و ببینید آنتن لازم از <b>یک رشته‌کوه به یک گیره‌ی کاغذ</b> آب می‌رود. هیچ‌چیزِ فیزیک عوض نشده؛ فقط فرکانس. همین یک نمودار، نیمه‌ی اول دلیل وجود مدولاسیون است.",
      "s1.summary1": "نمی‌شود آنتن کوچک‌تر ساخت و افتش را قبول کرد؟",
      "s1.p5": "می‌شود، و گوشی‌ها هر روز همین کار را می‌کنند، ولی مجانی نیست. آنتنی که خیلی کوتاه‌تر از یک‌چهارم طول موج باشد <em>مقاومت تشعشعی</em> بسیار کوچکی دارد — همان بخشی که توان را به موج رادیویی تبدیل می‌کند. بقیه‌ی توان در مس و در مدار تطبیق به گرما تبدیل می‌شود.",
      "s1.p6": "آنتن کوتاه به فرکانس هم خیلی حساس می‌شود: فقط در باند باریکی کار می‌کند و بدون یک مدار تطبیق دقیق اصلاً کار نمی‌کند. با طراحی هوشمندانه می‌شود آنتن را ده برابر کوچک کرد؛ نمی‌شود ده‌هزار برابر کوچکش کرد، و فرستادن مستقیم صدا دقیقاً همین را از شما می‌خواهد.",
      "s1.h32": "مشکل دوم: همه در یک اتاق داد می‌زنند",
      "s1.p7": "فرض کنید مشکل آنتن حل شده. هنوز دیوار دومی سر جایش است. هر میکروفونی در دنیا همان محدوده‌ی فرکانسی را تولید می‌کند، تقریباً ۲۰ هرتز تا ۲۰ کیلوهرتز. اگر دو ایستگاه صدایشان را مستقیم بفرستند، دو سیگنال روی هم می‌رسند و با هم جمع می‌شوند.",
      "s1.p8": "فیلتر فقط می‌تواند سیگنال‌هایی را از هم جدا کند که در <em>جاهای متفاوتی</em> از فرکانس باشند. اینجا هر دو در یک جا هستند، پس چیزی برای فیلتر کردن وجود ندارد. نتیجه: یک فرستنده برای هر شهر، برای همه، تا ابد.",
      "s1.p9": "هر دو مشکل یک جواب دارند. <strong>پیام را ببر بالا روی یک فرکانس بلند، و به هر فرستنده یکی متفاوت بده.</strong> مدولاسیون برای همین است.",
      "s2.h21": "<span class=\"secnum\">۰۲</span> حامل، که هیچ‌چیز حمل نمی‌کند",
      "s2.p1": "به موج پرفرکانسی که پیام را رویش می‌بریم <strong>حامل</strong> می‌گویند. خودش یک سینوسی ساده است:",
      "s2.lbl1": "موج حامل",
      "s2.p2": "به‌تنهایی هیچ اطلاعاتی در آن نیست. ارتفاعش هیچ‌وقت عوض نمی‌شود، فرکانسش عوض نمی‌شود، زمان‌بندی‌اش هم عوض نمی‌شود. اگر روی تحلیلگر طیف نگاهش کنید یک خط می‌بینید و بس. گوش دادن به حاملِ مدوله‌نشده دقیقاً یک چیز به شما می‌گوید: فرستنده روشن است.",
      "s2.p3": "و نکته دقیقاً همین است. موج سینوسی سه ویژگی دارد که می‌شود عوضشان کرد، و گیرنده می‌تواند تغییر هر کدام را تشخیص بدهد:",
      "s2.th1": "این را عوض کن",
      "s2.th2": "به دست می‌آید",
      "s2.th3": "گیرنده مراقب چیست",
      "s2.td1": "دامنه",
      "s2.td2": "AM",
      ...
      "s2.p4": "<strong>مدولاسیون</strong> یعنی کاری کنیم یکی از این سه ویژگی از پیام پیروی کند، و <strong>دمدولاسیون</strong> یعنی همان را در آن سر خط دوباره بخوانیم. این نوشته سطر اول جدول را دنبال می‌کند.",
      "s2.pull1": "حامل هیچ اطلاعاتی حمل نمی‌کند. دقیقاً به همین دلیل است که می‌شود روی آن اطلاعات نوشت.",
      "s3.h21": "<span class=\"secnum\">۰۳</span> مدولاسیون دامنه دقیقاً چه می‌کند",
      "s3.p1": "پیام را x(t) بنامید و طوری مقیاسش کنید که هیچ‌وقت از بازه‌ی −۱ تا +۱ بیرون نزند. مدولاسیون دامنه ارتفاع ثابتِ A<sub>c</sub> را با ارتفاعی جایگزین می‌کند که تکان می‌خورد:",
      ...
      "s3.note1": "<b>یک توضیح درباره‌ی شکل‌ها.</b> در پخش واقعی، حامل هزاران بار تندتر از پیام است — یک ایستگاه AM روی ۱ مگاهرتز که تُن ۱ کیلوهرتزی می‌فرستد، نسبت ۱۰۰۰ به ۱ دارد. اگر صادقانه بکشیمش، یک لکه‌ی توپر جوهر می‌شود. اینجا هر شکلی نسبتی در حد چند ده استفاده می‌کند تا شکل موج دیده شود — و در تنها شکلی که می‌شود به آن گوش داد، تا ریپلِ آشکارساز روی فرکانسی بیفتد که بلندگو واقعاً پخشش کند. ریاضیاتش هیچ فرقی نمی‌کند.<br><br><b>سه تا از شکل‌های پایین‌تر صدا دارند</b> — شاخص مدولاسیون، آشکارساز، و دیال تنظیم ایستگاه. تا نخواهید چیزی پخش نمی‌شود، و هر بار فقط یکی.",
      "s4.h21": "<span class=\"secnum\">۰۴</span> شاخص مدولاسیون، و راه خراب کردنش",
      "s4.p1": "شاخص m تعیین می‌کند نوسان چقدر عمیق باشد. با یک تُن تنها، پوش در پایین‌ترین نقطه به A<sub>c</sub>(1 − m) و در بالاترین نقطه به A<sub>c</sub>(1 + m) می‌رسد؛ پس می‌شود m را روی صفحه‌ی نمایش اندازه گرفت، بدون اینکه چیز دیگری از فرستنده بدانید:",
      "s4.lbl1": "شاخص مدولاسیون، اندازه‌گیری‌شده",
      "s4.p2": "سه حالت مهم‌اند، و فقط همین سه تا:",
      "s4.li1": "<b>m &lt; 1</b> — پوش بالای صفر می‌ماند و همه‌چیز کار می‌کند. m = 0.5 یعنی ارتفاع بین نصف و یک‌ونیم برابر حامل نوسان می‌کند.",
      "s4.li2": "<b>m = 1</b> — مدولاسیون کامل. پوش در پایین‌ترین نقطه دقیقاً صفر را لمس می‌کند. این بلندترین حدی است که AM استاندارد اجازه دارد برود، و همان‌جاست که بیشترین سهم توان به پیام می‌رسد.",
      "s4.li3": "<b>m &gt; 1</b> — <b>فرامدولاسیون.</b> کروشه‌ی [1 + m·x(t)] منفی می‌شود. پوش نمی‌تواند دنبالش برود، پس تا می‌خورد و برمی‌گردد بالا و دیگر کپی پیام نیست. گیرنده اعوجاج زننده‌ای می‌شنود، و سیگنال فرستاده‌شده تا بیرون کانال خودش پخش می‌شود و مزاحم همسایه‌ها می‌شود.",
      "s4.monolabel1": "شاخص مدولاسیون m",
      "s4.audiohint1": "همان چیزی که گیرنده پخش می‌کند",
      "s4.figcaption1": "نمودار بالا سیگنال فرستاده‌شده است با V<sub>max</sub> و V<sub>min</sub> علامت‌خورده؛ نمودار پایین چیزی است که یک گیرنده‌ی ساده با دنبال کردن پوش بیرون می‌کشد. زیر m = 1 دو شکل بر هم منطبق‌اند. از m = 1 که رد شوید، ببینید <b>شکاف‌های تیزی</b> در نمودار پایین سبز می‌شود که هرگز در پیام نبودند — این همان فرامدولاسیون است، و رایج‌ترین شکل بد تنظیم شدن یک فرستنده‌ی AM. به m = 0 هم سر بزنید: یک حاملِ بی‌نقص و بی‌فایده. <b>دکمه‌ی گوش دادن را بزنید</b> و اسلایدر را بکشید: نمودار پایین به صدا تبدیل می‌شود، پس m = 0 سکوت است، وسط یک تُن تمیز، و هر چه از m = 1 بگذرید بیشتر به وزوز می‌زند.",
      "s4.summary1": "چرا پوشِ منفی به شکل وارونگی فاز برمی‌گردد؟",
      ...
      "s4.p4": "اما آشکارساز پوش از فاز خبر ندارد. فقط اندازه می‌گیرد که موج چقدر بلند است، و بلندی علامت ندارد. پس |1 + m·x(t)| را گزارش می‌کند و بخش منفی تا می‌خورد و برمی‌گردد بالا. یعنی فرامدولاسیون مشکلِ سیگنال نیست؛ مشکلِ آن گیرنده‌ی ارزان است — همان گیرنده‌ای که دست همه است.",
      "s5.h21": "<span class=\"secnum\">۰۵</span> همان سیگنال، این‌بار در فرکانس",
      "s5.p1": "تا اینجا هرچه دیدیم تصویر ولتاژ بر حسب زمان بود. نمای دیگر — ولتاژ بر حسب فرکانس — جایی است که AM نشان می‌دهد واقعاً چه کرده. حالت تک‌تُن را بردارید، x(t) = cos(2π f<sub>m</sub> t)، و کروشه‌ها را باز کنید:",
      ...
      "s5.p3": "پیام واقعی یک تُن نیست، یک باند کامل است، از نزدیک صفر تا بالاترین فرکانسش که B می‌نامیمش. هر تُنی داخل آن جفت خودش را می‌سازد، پس نتیجه دو کپی قرینه از طیف پیام است، هر طرف حامل یکی. حالا سیگنال این‌قدر جا می‌گیرد:",
      "s5.lbl2": "پهنای باند ارسال",
      "s5.small2": "دو برابر بالاترین فرکانس پیام",
      "s5.p4": "به همین دلیل است که یک کانال پخش AM ده کیلوهرتز پهنا دارد در حالی که صدای داخلش حدود پنج کیلوهرتز بیشتر بالا نمی‌رود. پول کپی دوم را می‌دهید، چه بخواهید چه نخواهید.",
      "s5.monolabel1": "فرکانس پیام",
      "s5.monolabel2": "شاخص مدولاسیون m",
      "s5.figcaption1": "پایین، پیام است همان‌جا که شروع می‌شود، نزدیک صفر. بالا، سیگنال فرستاده‌شده است که دور حامل ۱ مگاهرتزی نشسته. فرکانس پیام را بکشید تا دو باند کناری با هم از حامل دور شوند، همیشه به یک اندازه از هر طرف، و پهنای باند دقیقاً دو برابر آن را دنبال کند. m را تا صفر پایین بیاورید: باندهای کناری محو می‌شوند و حامل دست‌نخورده سر جایش می‌ماند — <b>تمام اطلاعات در باندهای کناری است و هیچ‌کدامش در حامل نیست</b>. روی <b>باند گفتار</b> بروید تا ببینید پیام واقعی چه شکلی است: دو مثلث قرینه.",
      ...
      "s5.p5": "باند کناری پایینی روی f<sub>c</sub> − f<sub>m</sub> می‌نشیند. تُنِ <em>بالاتر</em> پیام آنجا فرکانس <em>پایین‌تری</em> می‌دهد، پس هرچه طیف پیام بالا می‌رود، باند کناری پایینی رو به پایین راه می‌رود. همان اطلاعات است، فقط روی محور فرکانس برعکس خوانده می‌شود.",
      "s5.p6": "هر دو باند کناری پیام کامل را دارند. ارسال تک‌باند کناری (SSB) دقیقاً همین افزونگی را دور می‌ریزد: یکی‌شان را فیلتر کنید و همان اطلاعات را با نصف پهنای باند بفرستید — به قیمت گیرنده‌ای به‌مراتب سختگیرتر.",
      "s6.h21": "<span class=\"secnum\">۰۶</span> توان کجا می‌رود",
      "s6.p1": "حالا نوبت قیمتش است. با پیام تک‌تُن، توان متوسط سیگنال AM به یک جمله‌ی حامل و دو جمله‌ی باند کناری تقسیم می‌شود:",
      "s6.lbl1": "توان کل فرستاده‌شده",
      "s6.small1": "هر باند کناری P<sub>c</sub>m²/4 می‌برد · حامل هرچه باشد P<sub>c</sub> را می‌برد",
      "s6.p2": "جمله‌ی حامل اصلاً به m وابسته نیست. وقتی ایستگاه موسیقی پخش می‌کند آنجاست، و وقتی هیچ‌کس حرف نمی‌زند هم آنجاست. و یک بخش قبل‌تر ثابت کردیم که حامل هیچ اطلاعاتی ندارد. پس سهم مفید این است:",
      "s6.lbl2": "بازده",
      "s6.small2": "در بهترین حالت، با m = 1: η = 1/3",
      "s6.p3": "حتی در مدولاسیون کامل هم، یک فرستنده‌ی AM استاندارد <b>دوسوم توانش را خرج موجی می‌کند که هیچ نمی‌گوید</b>. ایستگاهی با حامل ۵۰ کیلوواتی، آن ۵۰ کیلووات را چه کسی حرف بزند چه نزند تابش می‌کند و حداکثر ۲۵ کیلووات باند کناری رویش می‌گذارد. در عمل هم گفتار و موسیقی به‌طور متوسط خیلی پایین‌تر از m = 1 کار می‌کنند، پس عدد واقعی بدتر است — اغلب فقط چند درصد.",
      "s6.monolabel1": "شاخص مدولاسیون m",
      "s6.monolabel2": "توان حامل",
      "s6.figcaption1": "نوار، توان کل فرستاده‌شده است، تقسیم‌شده به بخشی که پیام را حمل می‌کند و بخشی که نمی‌کند. منحنی زیرش بازده بر حسب m است، با تنظیم فعلی شما علامت‌خورده. m را تا انتها ببرید روی ۱ تا منحنی روی <b>۳۳٫۳٪</b> سقف بزند — این محدودیت تجهیزات نیست، حساب‌وکتاب خود AM استاندارد است. هر جای دیگری سمت چپ آن نقطه، بدتر است.",
      "s6.summary1": "پس اصلاً چرا حامل را می‌فرستیم؟",
      "s6.p4": "چون حامل همان چیزی است که پوش را به کپی وفادار پیام تبدیل می‌کند. برش دارید تا به <b>DSB-SC</b> برسید — دوباند کناری با حامل سرکوب‌شده — که صد در صد توانش خرج اطلاعات می‌شود، ولی پوشش دیگر هیچ شباهتی به پیام ندارد. بازیابی‌اش گیرنده‌ای می‌خواهد که حاملی هم‌فاز با فرستنده بسازد.",
      "s6.p5": "معامله‌ی اصلی AM همین است: فرستنده توان هدر می‌دهد تا هر گیرنده‌ای بتواند بی‌اهمیت و ساده باشد. یک ایستگاه گران، میلیون‌ها رادیوی ارزان. برای پخش همگانی، همین طرفِ درست معامله است.",
      "s7.h21": "<span class=\"secnum\">۰۷</span> پس گرفتن پیام",
      "s7.p1": "و این پاداش تمام آن توان هدررفته است. پیام داخل پوش نشسته، و اندازه گرفتن یک پوش سه قطعه لازم دارد: یک <strong>دیود</strong>، یک <strong>مقاومت</strong> و یک <strong>خازن</strong>.",
      "s7.p2": "دیود فقط نیمه‌ی مثبت موج ورودی را رد می‌کند. هر قله‌ی مثبت خازن را تا ارتفاع همان قله شارژ می‌کند، و بین دو قله خازن آرام‌آرام از مقاومت تخلیه می‌شود. پس ولتاژ خازن با هر قله‌ی تازه بالا می‌پرد و در فاصله‌ی بینشان کمی می‌افتد — یعنی کپی‌ای از پوش، با کمی موج‌دار بودن رویش.",
      ...
      "s7.p4": "اگر RC خیلی کوچک باشد، خازن بین هر دو قله‌ی حامل خالی می‌شود و خروجی نسخه‌ای زبر و موج‌دار از موج درمی‌آید. اگر RC خیلی بزرگ باشد، خازن نمی‌تواند به تندی پوش پایین بیاید و خروجی گوشه را با یک خط راست می‌برد — خرابی‌ای با اسم بامزه‌ی <strong>بریدگی مورب</strong>. بین این دو، کار می‌کند.",
      "s7.monolabel1": "ثابت زمانی RC",
      "s7.audiohint1": "بعد RC را همین‌طور که پخش می‌شود بکشید",
      "s7.figcaption1": "موج کم‌رنگ چیزی است که به آنتن می‌رسد؛ خط پررنگ ولتاژ روی خازن است که قله به قله شبیه‌سازی شده. RC را تا انتهای چپ بکشید تا <b>ریپل</b> را ببینید — آشکارساز دارد به‌جای پوش، حامل را دنبال می‌کند. تا انتهای راست بکشید تا <b>بریدگی مورب</b> را ببینید — برش‌های شیب‌دار و صاف، جایی که خروجی به‌قدر کافی تند نتوانسته پایین بیاید. پنجره‌ی بین این دو پهن است، و دقیقاً به همین دلیل این مدار هیچ‌وقت لازم نشده باهوش باشد. <b>دکمه‌ی گوش دادن</b> همین آشکارساز را با همه‌چیزِ مقیاس‌شده به محدوده‌ی شنوایی پخش می‌کند و RC × f<sub>c</sub> و RC × f<sub>m</sub> را دقیقاً همان‌طور که روی صفحه هستند نگه می‌دارد — پس ریپلی که می‌بینید همان ریپلی است که می‌شنوید. <b>همین‌طور که پخش می‌شود RC را بکشید:</b> سر تند وزوز می‌کند چون خروجی دارد حامل را دنبال می‌کند؛ وسط یک تُن تمیز است و بلندترین حالت از هر سه؛ سر کند آرام و خشن می‌شود.",
      "s7.p5": "به چیزی که در آن مدار <em>نیست</em> دقت کنید: نه منبع تغذیه، نه نوسان‌ساز، نه هیچ چیزی که لازم باشد فاز فرستنده را بداند. یک دیود و دو قطعه‌ی غیرفعال، گفتار را از هوا بیرون می‌کشند. این تمام بازدهی است که از آن دوسوم توانِ دورریخته‌شده‌ی بخش ۶ به دست می‌آید.",
      "s8.h21": "<span class=\"secnum\">۰۸</span> ایستگاه‌های زیاد، یک آسمان",
      "s8.p1": "برگردیم به مشکل دوم بخش ۱. به هر ایستگاه فرکانس حامل خودش را می‌دهند، پس جفت باندهای کناری هر ایستگاه در شکاف مخصوص خودش روی محور فرکانس می‌نشیند. شکاف‌ها کنار هم چیده می‌شوند و هیچ‌کدام روی دیگری نمی‌افتد. این چیدمان اسم دارد: <strong>مالتی‌پلکس تقسیم فرکانسی</strong>.",
      "s8.p2": "آنتن شما همه‌شان را با هم می‌گیرد و جمعشان می‌کند، که ظاهراً همان آشفتگی قبلی است — با یک تفاوت: حالا واقعاً در <em>جاهای متفاوتی</em> از فرکانس‌اند، پس فیلتر می‌تواند جدایشان کند. یک فیلتر میان‌گذر را روی یک شکاف تنظیم کنید، بقیه را دور بریزید، و آنچه باقی می‌ماند را به آشکارساز پوش بدهید. کاری که پیچ تنظیم رادیو می‌کند دقیقاً همین است.",
      ...
      "s8.figcaption1": "چهار ایستگاه در یک باند شریک‌اند؛ هرکدام یک خط حامل با دو باند کناری خودش. پنجره‌ی سایه‌دار فیلتر گیرنده‌ی شماست، و نمودار زیرش صدایی است که از آشکارساز بیرون می‌آید. روی یک ایستگاه بنشینید تا پیام تمیز باشد. بین دو تا بایستید تا تقریباً هیچ نگیرید. حالا فیلتر را از <b>۲۰ کیلوهرتز</b> پهن‌تر کنید و در باند بالا بروید: پنجره دو ایستگاه را با هم می‌بلعد و صدای بازیابی‌شده مخلوط هر دو می‌شود — همان تداخلی که فاصله‌گذاری کانال‌ها برای جلوگیری از آن وجود دارد. هر ایستگاه نُتی متفاوت با شکل موجی متفاوت می‌فرستد، پس <b>دکمه‌ی گوش دادن را بزنید و دیال را بچرخانید</b>: یک ایستگاه می‌شنوید، بعد خش‌خش بین آن‌ها، و جایی که فیلتر زیادی پهن است، دو نُت با هم.",
      ...
      "s9.li2": "مدولاسیون هر دو را با یک کار حل می‌کند — پیام را می‌برد بالا روی فرکانس حامل، و برای هر فرستنده حامل متفاوتی انتخاب می‌کند.",
      "s9.li3": "در AM پیام <em>ارتفاع</em> حامل را کنترل می‌کند و شکل پیام به‌صورت پوش ظاهر می‌شود: s(t) = A<sub>c</sub>[1 + m·x(t)]cos(2πf<sub>c</sub>t).",
      "s9.li4": "شاخص m باید یک یا کمتر بماند. بالاتر از آن پوش تا می‌خورد و گیرنده‌ی ساده اعوجاج می‌شنود.",
      "s9.li5": "در فرکانس، نتیجه یک حامل است و دو باند کناری، پس AM دو برابر پهنای باند پیام جا می‌گیرد و حداکثر یک‌سوم توان کار مفید می‌کند.",
      ...
      "s9.p3": "همه‌شان یک جمله‌اند با لباس‌های متفاوت: <em>یک موج یکنواخت بردار، و بگذار پیام یک چیزش را عوض کند</em>.",
      "s9.h31": "بیشتر از این جنس",
      "s9.p4": "اگر یک تکه‌ی دیگر از RF را می‌خواهید که از صفر و با شکل‌هایی که می‌شود خرابشان کرد توضیح داده شده باشد، مقاله‌ی نمودار اسمیت همین کار را برای امپدانس، بازتاب و تطبیق می‌کند — و خود نمودار هم زنده در آزمایشگاه اجرا می‌شود.",
      ...
      "meta.og:description": "چرا صدا را نمی‌شود به شکل صدا فرستاد — و مدولاسیون دامنه چطور این را حل می‌کند. هفت شکل زنده، بدون نیاز به پیش‌زمینه.",
      ...
      "js.f7.v0": "بین دو ایستگاه. فیلتر روی طیف خالی نشسته، پس چیزی جز نویز به آشکارساز نمی‌رسد.",
      ...
      "js.f7.v2b": ". باندهای کناری هر دو به آشکارساز می‌رسند و مخلوطشان را می‌شنوید. ",
      ...
      "js.f7.v2a": "دو ایستگاه داخل یک پنجره: ",
